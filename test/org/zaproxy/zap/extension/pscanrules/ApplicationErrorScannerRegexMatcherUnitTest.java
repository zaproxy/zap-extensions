...
public class ApplicationErrorScannerRegexMatcherUnitTest {
    ...
    private static final ContentMatcher MATCHER =
            ContentMatcher.getInstance(ApplicationErrorScannerRegexMatcherUnitTest.class.getResourceAsStream(APP_ERRORS_FILE));
    ...
    @Test
    public void shouldRegexMatchErrorMessage() {
        Assert.assertNotNull(MATCHER.findInContent(INPUT_PREFIX + input + INPUT_SUFFIX));
    }
}
