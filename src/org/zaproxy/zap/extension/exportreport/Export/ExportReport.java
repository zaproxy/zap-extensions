...
public class ExportReport {
	...
	class Task extends SwingWorker<Void, Void> {
		...
		public Void doInBackground() {
			...
			catch (UnsupportedEncodingException e)
			{
				...
				view.showMessageDialog(Constant.messages.getString("exportreport.message.error.dump"));
			}
			...
			try {
				...
				logger.error(e.getMessage(), e);
				view.showMessageDialog(Constant.messages.getString("exportreport.message.error.file.open"));
			}
			return null;
		}
	...
	private void deleteFile(String str, String err) {
		...
		if (!deleted) {
			logger.error(Constant.messages.getString("exportreport.message.error.file.delete"));
			// Consider also throwing GUI error?
		}
	}
}
