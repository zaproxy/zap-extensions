 ...
 */
package org.zaproxy.zap.extension.jxbrowserlinux32;
...
public class ExtensionJxBrowserLinux32 extends ExtensionAdaptor {

    public static final String NAME = "ExtensionJxBrowserLinux32";

    private static final Logger LOGGER = Logger.getLogger(ExtensionJxBrowserLinux32.class);
    ...
    public ExtensionJxBrowserLinux32() {
        super(NAME);
    }
