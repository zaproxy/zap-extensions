...
/**
 * Service class used to store a boundary element
...
public class SQLiBoundary {
     ...
     * 4: Extensive test (500-1000 requests) 5: You have plenty of time (>1000 requests)
     *
     * Sub-tag: <clause>
     * In which clause the payload can work.
     *
     * NOTE: for instance, there are some payload that do not have to be tested
     * as soon as it has been identified whether or not the injection is within
     ...
     *
     * Valid values: 1: Unescaped numeric 2: Single quoted string 3: LIKE single
     * quoted string 4: Double quoted string 5: LIKE double quoted string
     *
     * Sub-tag: <prefix>
