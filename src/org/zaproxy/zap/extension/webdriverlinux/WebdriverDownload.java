...
public class WebdriverDownload {
	...
	public static void main(String[] args) {
		...
		downloadDriver("https://chromedriver.storage.googleapis.com/2.27/chromedriver_linux32.zip",
				"files/webdriver/linux/32/", "chromedriver");

		downloadDriver("https://chromedriver.storage.googleapis.com/2.27/chromedriver_linux64.zip",
