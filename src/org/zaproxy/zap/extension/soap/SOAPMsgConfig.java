...
/**
 * This class encapsulates all required variables to craft a SOAP request
 * message.
 * 
 * @author Albertov91
 *
...
public class SOAPMsgConfig {
	...
	public SOAPMsgConfig(Definitions wsdl, int soapVersion, HashMap<String, String> params, Port port,
	...
	public boolean isComplete() {
		if (this.wsdl == null || this.soapVersion < 1 || this.soapVersion > 2 || this.params == null
				|| this.port == null || this.bindOp == null)
			return false;
		else
			return true;
	}
	...
	private int getHash() {
		...
		if (this.wsdl != null)
			sb.append(this.wsdl.getAsString());
