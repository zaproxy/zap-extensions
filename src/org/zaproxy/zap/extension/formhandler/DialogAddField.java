...
class DialogAddField extends AbstractFormDialog {
    ...
    private static final String DIALOG_TITLE = Constant.messages.getString("formhandler.options.dialog.field.add.title");

    private static final String CONFIRM_BUTTON_LABEL = Constant.messages.getString("formhandler.options.dialog.field.add.button.confirm");

    private static final String NAME_FIELD_LABEL = Constant.messages.getString("formhandler.options.dialog.field.field.label.name");
    private static final String VALUE_FIELD_LABEL = Constant.messages.getString("formhandler.options.dialog.field.field.label.value");
    private static final String ENABLED_FIELD_LABEL = Constant.messages.getString("formhandler.options.dialog.field.field.label.enabled");

    private static final String TITLE_NAME_REPEATED_DIALOG = Constant.messages.getString("formhandler.options.dialog.field.warning.name.repeated.title");
    ...
    /**
     * When the Add button is clicked, create a new field.
     * This field will be created with the name, value and enabled input by the user.
     * The name will always be lower case.
     */
    @Override
    protected void performAction() {
        field = new FormHandlerParamField(getNameTextField().getText().toLowerCase(), getValueTextField().getText(), getEnabledCheckBox().isSelected());
    }
