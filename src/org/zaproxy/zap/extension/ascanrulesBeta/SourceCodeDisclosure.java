                    ...
                    if (randomversussourcefilenamematchpercentage  > this.thresholdPercentage) {
                    	...
                    	if (responseIsSource) {
		                    ...
		                    bingo(Alert.RISK_HIGH, Alert.WARNING,
		                    		Constant.messages.getString("ascanbeta.sourcecodeinclusion.name"),
		                    		Constant.messages.getString("ascanbeta.sourcecodeinclusion.desc"), 
		                    		getBaseMsg().getRequestHeader().getURI().getURI(),
		                            paramname, 
		                            prefixedUrlfilename,
		                            Constant.messages.getString("ascanbeta.sourcecodeinclusion.extrainfo"),
		                            Constant.messages.getString("ascanbeta.sourcecodeinclusion.soln"),
		                            Constant.messages.getString("ascanbeta.sourcecodeinclusion.evidence", 
		                            		prefixedUrlfilename, NON_EXISTANT_FILENAME, randomversussourcefilenamematchpercentage, this.thresholdPercentage),
		                            sourceattackmsg
		                            );
