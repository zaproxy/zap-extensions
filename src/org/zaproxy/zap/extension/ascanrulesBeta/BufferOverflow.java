...
public class BufferOverflow extends AbstractAppParamPlugin  {
	 ...
	 */
	private static final String MESSAGE_PREFIX = "ascanbeta.bufferoverflow.";
	...
	public void scan(HttpMessage msg, String param, String value) {
		...
		try {
    		...
    		if (msg.getResponseHeader().getStatusCode() == HttpStatusCode.INTERNAL_SERVER_ERROR && chkerrorheader.contains(checkStringHeader1))
    		{
