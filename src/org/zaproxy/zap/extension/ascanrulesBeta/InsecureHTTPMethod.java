...
public class InsecureHTTPMethod extends AbstractAppPlugin {
    ...
    public void scan() {
        try {
            ...
            if (attackStrength == AttackStrength.HIGH || attackStrength == AttackStrength.INSANE) {
                ...
                // this is useful in the case where the OPTIONS method does not report the method, but where it is actually
                // supported
                // in this case, if a vulnerability is reported, there is little doubt that it is real
                // try the TRACK method
                MessageAndEvidence maeTrack = testTraceOrTrack(this.getBaseMsg(), HTTP_METHOD_TRACK);
                if (maeTrack != null) {
                    bingo(
                            Alert.RISK_MEDIUM,
                            Alert.CONFIDENCE_MEDIUM,
                            Constant.messages.getString("ascanbeta.insecurehttpmethod.detailed.name", HTTP_METHOD_TRACK),
                            Constant.messages
                                    .getString("ascanbeta.insecurehttpmethod.trace.exploitable.desc", HTTP_METHOD_TRACK),
                            null, // originalMessage.getRequestHeader().getURI().getURI(),
                            null, // parameter being attacked: none.
                            "", // attack
                            Constant.messages
                                    .getString("ascanbeta.insecurehttpmethod.trace.exploitable.extrainfo", maeTrack.evidence),
                ...
                MessageAndEvidence maeTrace = testTraceOrTrack(this.getBaseMsg(), HTTP_METHOD_TRACE);
                if (maeTrace != null) {
                    bingo(
                            Alert.RISK_MEDIUM,
                            Alert.CONFIDENCE_MEDIUM,
                            Constant.messages.getString("ascanbeta.insecurehttpmethod.detailed.name", HTTP_METHOD_TRACE),
                            Constant.messages
                                    .getString("ascanbeta.insecurehttpmethod.trace.exploitable.desc", HTTP_METHOD_TRACE),
                            null, // originalMessage.getRequestHeader().getURI().getURI(),
                            null, // parameter being attacked: none.
                            "", // attack
                            Constant.messages
                                    .getString("ascanbeta.insecurehttpmethod.trace.exploitable.extrainfo", maeTrace.evidence),
                            Constant.messages.getString("ascanbeta.insecurehttpmethod.soln"),
                ...
                if (connectWorks) {
                    bingo(
                            Alert.RISK_MEDIUM,
                            Alert.CONFIDENCE_MEDIUM,
                            Constant.messages.getString("ascanbeta.insecurehttpmethod.detailed.name", HTTP_METHOD_CONNECT),
                            Constant.messages
                                    .getString("ascanbeta.insecurehttpmethod.connect.exploitable.desc", HTTP_METHOD_CONNECT),
                            null, // originalMessage.getRequestHeader().getURI().getURI(),
                            null, // parameter being attacked: none.
                            "", // attack
                            Constant.messages
                                    .getString("ascanbeta.insecurehttpmethod.connect.exploitable.extrainfo", thirdpartyHost),
                            Constant.messages.getString("ascanbeta.insecurehttpmethod.soln"),
            ...
            if (attackStrength != AttackStrength.HIGH && attackStrength != AttackStrength.INSANE) {
                ...
                /*
                 * //DEBUG only, to test the CONNECT method against a Squid instance, which does not support OPTIONS. //TODO:
                 * need to test for these insecure methods, even if the OPTIONS method did not indicate that the method is
                 * supported //ie, test for hidden/masked support for these insecure methods, as well as documented support.
                 * log.error("Setting the allowed methods to 'CONNECT'"); allowedmethods = "CONNECT"; publicmethods = null;
                 */
                        ...
                        if (enabledmethod.equals(insecureMethod)) {
                            ...
                            if (threshold != AlertThreshold.LOW) {
                                ...
                                if (enabledmethod.equals(HTTP_METHOD_TRACE) || enabledmethod.equals(HTTP_METHOD_TRACK)) {
                                    ...
                                    if (mae != null) {
                                        ...
                                        raiseAlert = true;
                                        description = Constant.messages.getString(
                                                "ascanbeta.insecurehttpmethod.trace.exploitable.desc",
                                                enabledmethod);
                                ...
                                extraInfo = Constant.messages
                                        .getString("ascanbeta.insecurehttpmethod.extrainfo", allowedmethods);
                            }
                            ...
                            if (raiseAlert) {
                                ...
                                bingo(
                                        ...
                                        Alert.CONFIDENCE_MEDIUM,
                                        Constant.messages
                                                .getString("ascanbeta.insecurehttpmethod.detailed.name", insecureMethod),
                                        description,
                                        null, // originalMessage.getRequestHeader().getURI().getURI(),
                                        null, // parameter being attacked: none.
                                        "", // attack
    ...
    private MessageAndEvidence testTraceOrTrack(HttpMessage baseMsg, String method) throws Exception {
        ...
        String randomcookiename = RandomStringUtils
                .random(15, "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789");
        String randomcookievalue = RandomStringUtils
