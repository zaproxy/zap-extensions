...
public class ModifyFuzzerMessageProcessorDialog<T1 extends Message, T2 extends FuzzerMessageProcessor<T1>, T3 extends FuzzerMessageProcessorUI<T1, T2>>
        extends AbstractFormDialog {

    private static final long serialVersionUID = 8111848758566016134L;

    private static final String DIALOG_TITLE = Constant.messages.getString("fuzz.fuzzer.dialog.modify.messageprocessor.title");
    private static final String TYPE_LABEL = Constant.messages.getString("fuzz.fuzzer.dialog.modify.messageprocessor.label.type");
    private static final String CONFIRM_BUTTON_LABEL = Constant.messages.getString("fuzz.fuzzer.dialog.modify.messageprocessor.button.confirm");
    ...
    public ModifyFuzzerMessageProcessorDialog(Dialog owner, FuzzerMessageProcessorUIPanel<T1, T2, T3> panel, T3 processorUI) {
