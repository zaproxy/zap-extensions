...
public class ModifyProcessorDialog<T0, T01 extends Payload<T0>, T1 extends PayloadProcessor<T0, T01>, T2 extends PayloadProcessorUI<T0, T01, T1>>
    ...
    private static final String DIALOG_TITLE = Constant.messages.getString("fuzz.fuzzer.dialog.modify.processor.title");
    private static final String TYPE_LABEL = Constant.messages.getString("fuzz.fuzzer.dialog.modify.processor.label.type");
    private static final String CONFIRM_BUTTON_LABEL = Constant.messages.getString("fuzz.fuzzer.dialog.modify.processor.button.confirm");
