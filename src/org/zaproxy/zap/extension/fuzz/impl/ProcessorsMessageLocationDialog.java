...
public class ProcessorsMessageLocationDialog extends AbstractFormDialog {
    ...
    private static final String CONFIRM_BUTTON_LABEL = Constant.messages.getString("fuzz.fuzzer.dialog.messagelocations.dialog.processors.button.confirm");

    private static final String REMOVE_DIALOG_TITLE = Constant.messages.getString("fuzz.fuzzer.dialog.messagelocations.dialog.remove.processor.title");
    private static final String REMOVE_DIALOG_TEXT = Constant.messages.getString("fuzz.fuzzer.dialog.messagelocations.dialog.remove.processor.text");

    private static final String REMOVE_DIALOG_CONFIRM_BUTTON_LABEL = Constant.messages.getString("fuzz.fuzzer.dialog.messagelocations.dialog.remove.processor.button.confirm");
    private static final String REMOVE_DIALOG_CANCEL_BUTTON_LABEL = Constant.messages.getString("fuzz.fuzzer.dialog.messagelocations.dialog.remove.processor.button.cancel");

    private static final String REMOVE_DIALOG_CHECKBOX_LABEL = Constant.messages.getString("fuzz.fuzzer.dialog.messagelocations.dialog.remove.processor.checkbox.label");
    ...
    public ProcessorsMessageLocationDialog(Dialog parent, PayloadProcessorsContainer processorsUIHandlers) {
        super(parent, Constant.messages.getString("fuzz.fuzzer.dialog.messagelocations.dialog.processors.title"), false);
    ...
    protected JPanel getFieldsPanel() {
        ...
        JLabel locationLabel = new JLabel(
                Constant.messages.getString("fuzz.fuzzer.dialog.messagelocations.dialog.processors.location.label"));
        ...
        JLabel payloadsLabel = new JLabel(
                Constant.messages.getString("fuzz.fuzzer.dialog.messagelocations.dialog.processors.processors.label"));

        layout.setHorizontalGroup(layout.createParallelGroup()
                .addGroup(layout.createSequentialGroup().addComponent(locationLabel).addComponent(messageLocationLabel))
                .addGroup(layout.createSequentialGroup().addComponent(valueLabel).addComponent(messageLocationValueLabel))
    ...
    private class ProcessorsTablePanel extends AbstractMultipleOrderedOptionsBaseTablePanel<PayloadProcessorTableEntry> {
        ...
        public ProcessorsTablePanel() {
            ...
            getTable().getColumnExt(2).setPrototypeValue("Description of Processors which is larger than the type.");
        ...
        public PayloadProcessorTableEntry showAddDialogue() {
            ...
            getMultipleOptionsModel().addElement(new PayloadProcessorTableEntry(getModel().getRowCount() + 1, processorUI));
