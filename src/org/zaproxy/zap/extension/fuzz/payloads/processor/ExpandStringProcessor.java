...
/**
 * A {@code StringPayloadProcessor} that allows to expand the payload up to a given length appending a given value to begin or
 * end of the payload.
 */
public class ExpandStringProcessor implements StringPayloadProcessor {
