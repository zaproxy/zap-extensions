...
public class SHA1HashProcessorUIHandler implements
        PayloadProcessorUIHandler<String, StringPayload, SHA1HashProcessor, SHA1HashProcessorUI> {
    ...
    public static class SHA1HashProcessorUI extends AbstractStringHashProcessorUI<SHA1HashProcessor> {
        ...
        public String getDescription() {
            return MessageFormat.format(
                    Constant.messages.getString("fuzz.payload.processor.sha1Hash.description"),
                    getCharset().name());
        }
