 ...
 * CLASS		:	FrameExportReport.java 
 * DESC			:	Sets up all the panels and adds them to the component pane, handles the card navigation.
...
{
	private final String			FINISH				= Constant.messages.getString("exportReport.forward.finish");
	...
	final String					PANEL_SOURCE		= Constant.messages.getString("exportReport.panel.source");
	final String					PANEL_RISK			= Constant.messages.getString("exportReport.panel.risk");
	final String					PANEL_DETAILS		= Constant.messages.getString("exportReport.panel.details");
	final String					cardItems[]			=
	{
			PANEL_SOURCE, PANEL_RISK, PANEL_DETAILS
	};
	...
	public FrameExportReport(ExtensionExportReport extension, PanelSource cardSource, PanelAlertRisk cardAlertRisk, PanelAlertDetails cardAlertDetails)
	{
		...
		this.setTitle(Constant.messages.getString("exportReport.menu.title"));
	...
	public void addComponentToPane(Container contentPane, PanelSource cardSource, PanelAlertRisk cardAlertRisk, PanelAlertDetails cardAlertDetails)
	{
		...
		pnlNav = new PanelNav(cardItems.length); // -Use the constructor to initialize the
		// navigation panel.
