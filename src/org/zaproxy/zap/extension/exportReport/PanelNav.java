 ...
 * CLASS		:	PanelNav.java 
 * DESC			:	Sets up the navigation panel and it's swing components.
...
public class PanelNav extends JPanel
{
	...
	private void initialize()
	{
		...
		btnBack = new JButton(Constant.messages.getString("exportReport.previous.back")); // -Create the back button and place it into the left row
		btnBack.setEnabled(false);
		navBar.add(btnBack);

		btnNext = new JButton(Constant.messages.getString("exportReport.forward.next")); // -Create the next button and place it into the right row
		navBar.add(btnNext);
	}
