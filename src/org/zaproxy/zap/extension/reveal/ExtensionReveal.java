...
public class ExtensionReveal extends ExtensionAdaptor implements ProxyListener {
	...
	private JToggleButton getRevealButton() {
		if (revealButton == null) {
			...
			revealButton.setIcon(new ImageIcon(ExtensionReveal.class.getResource("resource/icons/044.png"))); // 'light off' icon
			revealButton.setToolTipText(Constant.messages.getString("reveal.button.enable"));
			revealButton.setSelectedIcon(new ImageIcon(ExtensionReveal.class.getResource("resource/icons/043.png"))); // 'light on' icon
