                ...
                public void actionPerformed(java.awt.event.ActionEvent e) {
                	...
                	if (source != null && source instanceof PopupFuzzMenu) {
                		try{
                			...
                			final org.zaproxy.zap.extension.fuzz.FuzzableComponent invoker = (org.zaproxy.zap.extension.fuzz.FuzzableComponent) ((PopupFuzzMenu)source).getLastInvoker();
                			getFuzzableMessageHandler((invoker.getMessageClass())).showFuzzDialog(new FuzzableComponentWrapper(invoker));
                		}
                	}
                }
            });
