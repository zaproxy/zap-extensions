...
public class ContextAlertFilterPanel extends AbstractContextPropertiesPanel {
	...
	private static final String PANEL_NAME = Constant.messages.getString("alertFilters.panel.title");
	...
	private void initialize() {
		...
		this.add(new JLabel(Constant.messages.getString("alertFilters.panel.description")),
	...
	public static class AlertFiltersMultipleOptionsPanel extends AbstractMultipleOptionsTablePanel<AlertFilter> {
		...
		public AlertFiltersMultipleOptionsPanel(ExtensionAlertFilters extension, AlertFilterTableModel model,
				int contextId) {
			super(model);
			this.extension = extension;
