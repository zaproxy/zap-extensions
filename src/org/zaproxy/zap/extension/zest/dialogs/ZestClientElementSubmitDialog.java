...
public class ZestClientElementSubmitDialog extends ZestClientElementDialog implements ZestDialog {
	...
	public void init (ZestScriptWrapper script, ScriptNode parent, ScriptNode child, 
		...
		if (add) {
			...
			this.setTitle(Constant.messages.getString("zest.dialog.clientElementSubmit.edit.title"));
		}
	}
