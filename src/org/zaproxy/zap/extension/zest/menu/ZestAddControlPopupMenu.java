...
public class ZestAddControlPopupMenu extends ExtensionPopupMenuItem {
    ...
    private void createPopupAddControlMenu(final ScriptNode parent, final ScriptNode child, final ZestRequest req, final ZestControl za) {
		...
		menu.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (za instanceof ZestControlReturn) {
					extension.getDialogManager().showZestControlDialog(parent, child, req, za, true);
				} else {
					// The other controls dont have anything to edit, so just add them straight in.
