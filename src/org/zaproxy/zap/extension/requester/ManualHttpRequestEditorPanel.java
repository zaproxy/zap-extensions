 ...
 */
//Based on /zaproxy/src/org/parosproxy/paros/extension/manualrequest/http/impl/ManualHttpRequestEditorDialog.java
...
import org.zaproxy.zap.extension.requester.HttpPanelSender;
...
public class ManualHttpRequestEditorPanel extends ManualRequestEditorPanel {
	...
	public ManualHttpRequestEditorPanel(boolean isSendEnabled, String configurationKey, String helpKey) throws HeadlessException {
	...
	public static final class RequestResponsePanel extends JPanel {
		...
		public RequestResponsePanel(String configurationKey, HttpPanelRequest request, HttpPanelResponse response) throws IllegalArgumentException {
			...
			tabsButtonView = new JToggleButton(new ImageIcon(ManualRequestEditorPanel.class.getResource("/resource/icon/layout_tabbed.png")));
			...
			aboveButtonView = new JToggleButton(new ImageIcon(ManualRequestEditorPanel.class.getResource("/resource/icon/layout_vertical_split.png")));
			...
			sideBySideButtonView = new JToggleButton(new ImageIcon(ManualRequestEditorPanel.class.getResource("/resource/icon/layout_horizontal_split.png")));
		...
		public void loadConfig() {
			...
			changeView(Model.getSingleton().getOptionsParam().getConfig().getInt(configurationKey + SELECTEDLAYOUT_CONFIG_KEY, SIDE_BY_SIDE_VIEW));
