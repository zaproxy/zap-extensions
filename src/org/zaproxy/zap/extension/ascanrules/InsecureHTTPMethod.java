...
public class InsecureHTTPMethod extends AbstractAppPlugin {
     ...
     */
    public static List<String> INSECURE_METHODS;
    /**
    ...
    public String getName() {
        ...
        return Constant.messages.getString("ascanrules.insecurehttpmethod.name");
    }
    ...
    public void init() {
        if(INSECURE_METHODS==null) {
            ...
            //INSECURE_METHODS.addAll(new LinkedList<String>(Arrays.asList(INSECURE_DEFAULT_METHODS)));
            INSECURE_METHODS.addAll(Arrays.asList(INSECURE_DEFAULT_METHODS) );
            INSECURE_METHODS.addAll(Arrays.asList(WEBDAV_METHODS));
        }
            ...
            if (attackStrength == AttackStrength.HIGH || attackStrength == AttackStrength.INSANE) {
                ...
                if (maeTrack != null) {
                    bingo(Alert.RISK_MEDIUM, Alert.CONFIDENCE_MEDIUM, Constant.messages.getString("ascanrules.insecurehttpmethod.detailed.name", "TRACK"),
                            ...
                            Constant.messages.getString("ascanrules.insecurehttpmethod.soln"), maeTrack.evidence, // evidence,
                            // highlighted
                            // in
                            // the
                            // message
                ...
                if (maeTrace != null) {
                    bingo(Alert.RISK_MEDIUM, Alert.CONFIDENCE_MEDIUM, Constant.messages.getString("ascanrules.insecurehttpmethod.detailed.name", "TRACE"),
                            ...
                            Constant.messages.getString("ascanrules.insecurehttpmethod.soln"), maeTrace.evidence, // evidence,
                            // highlighted
                            // in
                            // the
                            // message
                ...
                if (connectWorks) {
                    bingo(Alert.RISK_MEDIUM, Alert.CONFIDENCE_MEDIUM, Constant.messages.getString("ascanrules.insecurehttpmethod.detailed.name", "CONNECT"),
                            ...
                            null, // parameter being attacked: none.
                            "", // attack
                            Constant.messages.getString("ascanrules.insecurehttpmethod.connect.exploitable.extrainfo", thirdpartyHost),
                            Constant.messages.getString("ascanrules.insecurehttpmethod.soln"), "", // evidence,
                            // highlighted
                            // in
                            // the
                            // message
                        ...
                        if (enabledmethod.equals(insecureMethod)) {
                            ...
                            if (threshold != AlertThreshold.LOW) {
                                ...
                                if (enabledmethod.equals("CONNECT")) {
                                    ...
                                    if (connectWorks) {
                                        ...
                                        // support
                                        // CONNECT
                                        description = Constant.messages.getString("ascanrules.insecurehttpmethod.connect.exploitable.desc", enabledmethod);
                                        extraInfo = Constant.messages.getString("ascanrules.insecurehttpmethod.connect.exploitable.extrainfo", thirdpartyHost);
                                    }
                                    ...
                                    if (mae != null) {
                                        ...
                                        description = Constant.messages.getString("ascanrules.insecurehttpmethod.trace.exploitable.desc", enabledmethod);
                                        extraInfo = Constant.messages.getString("ascanrules.insecurehttpmethod.trace.exploitable.extrainfo", evidence);
                                    }
                                ...
                                description = Constant.messages.getString("ascanrules.insecurehttpmethod.desc", enabledmethod);
                                extraInfo = Constant.messages.getString("ascanrules.insecurehttpmethod.extrainfo", allowedmethods);
                            }
                            ...
                            if (raiseAlert) {
                                ...
                                bingo(Alert.RISK_MEDIUM, Alert.CONFIDENCE_MEDIUM,
                                        Constant.messages.getString("ascanrules.insecurehttpmethod.detailed.name", insecureMethod), description, null, // originalMessage.getRequestHeader().getURI().getURI(),
                                        null, // parameter being attacked: none.
                                        "", // attack
                                        extraInfo, Constant.messages.getString("ascanrules.insecurehttpmethod.soln"), evidence, // evidence,
                                        // highlighted
                                        // in
                                        // the
                                        // message
    ...
    private final MessageAndEvidence testHttpMethod(String httpMethod) {
        ...
        if(httpMethod.equals(HttpRequestHeader.PUT)||httpMethod.equals(HttpRequestHeader.PATCH)) {
            tracemsg.setRequestBody(requestBody);
        }
        try {
        ...
        if (responseCode == HttpStatusCode.OK||responseCode==HttpStatusCode.CREATED) {
            ret = new MessageAndEvidence(tracemsg, responseCode+" for insecure HTTP METHOD");
        } else if (enabledStatusCodes.contains(responseCode)) {
            /* Raise a reduced risk alert */
            ret = new MessageAndEvidence(tracemsg,responseCode+" for potentially insecure HTTP METHOD");
        }
    ...
    private final DescriptionAndExtraInfo getMessageForHttpMethod(String httpMethod) {
        ...
        if (httpMethod.equals(HttpRequestHeader.DELETE)) {
            messages.description = Constant.messages.getString("ascanrules.insecurehttpmethod.delete.exploitable.desc");
            messages.extraInfo = Constant.messages.getString("ascanrules.insecurehttpmethod.delete.exploitable.extrainfo");
        }

        if (httpMethod.equals(HttpRequestHeader.OPTIONS)) {
            messages.description = Constant.messages.getString("ascanrules.insecurehttpmethod.options.exploitable.desc");
            messages.extraInfo = Constant.messages.getString("ascanrules.insecurehttpmethod.options.exploitable.extrainfo");
        }
