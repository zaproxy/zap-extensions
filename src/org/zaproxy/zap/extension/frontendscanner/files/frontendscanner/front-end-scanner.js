...
class FrontEndScanner {
  constructor() {
    this.zapAlertConstants = require('./zap-alert-constants.js');
    this.mailbox = global.mailbox;
  }

  reportAlertToZap(alertData) {
    alertData.historyReferenceId = HISTORY_REFERENCE_ID;

    const params = {
      alert: alertData
    };

    // CALLBACK_ENDPOINT has been injected by ZAP
    axios.post(CALLBACK_ENDPOINT, params)
      .then(response => {
