...
public class RevisitAPI extends ApiImplementor {
	...
	public RevisitAPI(ExtensionRevisit extension) {
		...
		this.addApiAction(new ApiAction(ACTION_REVISIT_SITE_ON, 
				new String[] { PARAM_SITE, PARAM_START_TIME, PARAM_END_TIME}));
		this.addApiAction(new ApiAction(ACTION_REVISIT_SITE_OFF,
	...
	public ApiResponse handleApiAction(String name, JSONObject params) throws ApiException {
		...
		case ACTION_REVISIT_SITE_ON:
			...
			Date endDate;
			try {
				startDate = ExtensionRevisit.dateFormat.parse(
						this.getParam(params, PARAM_START_TIME, ""));
				endDate = ExtensionRevisit.dateFormat.parse(
