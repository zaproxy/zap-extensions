...
public class ClientComponent implements HttpPanelComponentInterface, SearchableHttpPanelComponent {
	...
	private static final String BUTTON_TOOL_TIP = Constant.messages.getString("plugnhack.panel.component.all.tooltip");
	...
	protected void initUi() {
		// Common
		buttonShowView = new JToggleButton(new ImageIcon(
