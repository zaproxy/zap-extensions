...
public class RemoteCodeExecutionCVE20121823 extends AbstractAppPlugin {
	...
	public String getName() {
		return Constant.messages.getString("ascanalpha.remotecodeexecution.cve-2012-1823.name");
	}
			...
			for ( String payload : payloads) {
				...
				if (attackmsg.getResponseHeader().getStatusCode() == HttpStatus.SC_OK 
					...
					bingo(	Alert.RISK_HIGH, 
						...
						Constant.messages.getString("ascanalpha.remotecodeexecution.cve-2012-1823.desc"), 
