...
public class ExtensionDiff extends ExtensionAdaptor {
    ...
    private PopupMenuDiff getPopupMenuDiffRequests() {
        if (popupMenuDiffRequests== null) {
        	popupMenuDiffRequests = new PopupMenuDiff(Constant.messages.getString("diff.diff.req.popup"), this, true);
        }
    ...
    private PopupMenuDiff getPopupMenuDiffResponses() {
        if (popupMenuDiffResponses == null) {
        	popupMenuDiffResponses = new PopupMenuDiff(Constant.messages.getString("diff.diff.resp.popup"), this, false);
        }
    ...
    public void showDiffDialog (HttpMessage msg1, HttpMessage msg2, boolean request) throws Exception {
    	/* 
