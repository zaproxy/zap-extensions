...
public class Sample {
	...
	public static HttpMessage setRequestHeaderContent(HttpMessage msg) throws HttpMalformedHeaderException{
		msg.setRequestHeader("GET http://localhost/test/WS_162_https.wsdl HTTP/1.1"+
	...
	public static HttpMessage setResponseHeaderContent(HttpMessage msg) throws HttpMalformedHeaderException{
	...
	public static HttpMessage setOriginalRequest(HttpMessage msg) throws HttpMalformedHeaderException{
		...
		msg.setRequestBody("<?xml version=\"1.0 \" encoding= \"UTF-8\" ?>\r\n" +
	...
	public static HttpMessage setOriginalResponse(HttpMessage msg) throws HttpMalformedHeaderException{
		msg.setResponseHeader("HTTP/1.1 200 OK\r\n"+
