...
class JRubyAuthenticationScript 
  ...
  java_signature 'getCrendentialsParamsNames()'
  def getCrendentialsParamsNames()
  	return ["username", "password"]
  end
end

# This is required - don't delete it or you'll break the script
JRubyAuthenticationScript.new