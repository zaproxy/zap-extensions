...
public class SourceCodeDisclosureCVE20121823 extends AbstractAppPlugin {
	 ...
	 */
	private static final Pattern PHP_PATTERN1 = Pattern.compile(".*(<\\?php.+?\\?>).*", Pattern.MULTILINE | Pattern.DOTALL);  //PHP standard tags
	private static final Pattern PHP_PATTERN2 = Pattern.compile(".*(<\\?=.+?\\?>).*", Pattern.MULTILINE | Pattern.DOTALL);  //PHP "echo short tag"
	...
	public String getName() {
		return Constant.messages.getString("ascanalpha.sourcecodedisclosurecve-2012-1823.name");
	}
