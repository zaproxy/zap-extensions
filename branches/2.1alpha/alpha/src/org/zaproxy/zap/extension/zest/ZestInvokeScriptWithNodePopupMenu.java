...
public class ZestInvokeScriptWithNodePopupMenu extends PopupMenuSiteNode {
	 ...
	 * 
	 */
	public ZestInvokeScriptWithNodePopupMenu(ExtensionZest extension) {
    ...
    private void reCreateSubMenu() {
		...
		for (ZestScriptWrapper script : extension.getAscanScripts()) {
    ...
    private ExtensionPopupMenuItem createPopupAddToScriptMenu(ZestScript script) {
    	return new ZestInvokeScriptWithNodeMenu(extension, script);
	}
