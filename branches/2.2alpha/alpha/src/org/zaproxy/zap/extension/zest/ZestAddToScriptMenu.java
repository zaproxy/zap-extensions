...
public class ZestAddToScriptMenu extends PopupMenuSiteNode {

	private static final long serialVersionUID = 2282358266003940700L;
	
	private ExtensionZest extension;
	private ZestNode parent;
	...
	public ZestAddToScriptMenu(ExtensionZest extension, ZestNode parent) {
	...
	public void performAction(SiteNode sn) throws Exception {
		extension.addToParent(parent, sn, prefix);
	}
