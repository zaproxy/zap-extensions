...
public class EventStreamProxy {
	 ...
	 */
	public enum State {  
		CONNECTING, OPEN, CLOSED, // ready state
		EXCLUDED, INCLUDED; // no Server-Sent Events state, used for new black- or whitelisted streams
	}
...
//	private final HttpMessage message;
	...
	/**
	 * Keep track of the last event ID as it is used by subsequent events as
	 * long as a new one is retrieved.
	 */
...
//		this.message = message;
	...
	/**
	 * Interprets the event according to
	 * {@link http://www.w3.org/TR/eventsource/#event-stream-interpretation}.
	 * Call this method if newline occurred. Do not call for incomplete events.
	 * Discard pending data once the end of file is reached.
	 * 
	 * @param event
	 */
	...
	private static Comparator<EventStreamObserver> getObserversComparator() {
		if(observersComparator == null) {
				observersComparator = new Comparator<EventStreamObserver>() {
