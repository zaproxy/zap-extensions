...
public class OptionsZestPanel extends AbstractParamPanel {
	...
	private void initialize() {
        ...
        this.add(this.getIncResps(), 
        		LayoutHelper.getGBC(0, 0, 1, 1.0, new Insets(0,0,5,0)));
        this.add(new JLabel(Constant.messages.getString("zest.options.label.ignoreheaders")), 
        		LayoutHelper.getGBC(0, 1, 1, 1.0, new Insets(0,0,5,0)));
        this.add(getJScrollPane(), 
        		LayoutHelper.getGBC(0, 2, 1, 1.0, 1.0, GridBagConstraints.BOTH, 
	...
	private JCheckBox getIncResps() {
		if (incResps == null) {
			incResps = new JCheckBox(Constant.messages.getString("zest.options.label.incresponses"));
		}
		return incResps;
	}
	...
	private JScrollPane getJScrollPane() {
		if (jScrollPane == null) {
			...
			jScrollPane.setBorder(BorderFactory.createEtchedBorder(javax.swing.border.EtchedBorder.RAISED));
		}
		return jScrollPane;
	}
