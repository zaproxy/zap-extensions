...
public class ZestConditionDialog extends StandardFieldsDialog {
	...
	public void init(ScriptNode parent, List<ScriptNode> children,
		...
		if (condition.getRootExpression() instanceof ZestExpressionRegex) {
			ZestExpressionRegex za = (ZestExpressionRegex) condition
					.getRootExpression();
			this.addComboField(FIELD_LOCATION, new String[] { "HEAD", "BODY" },
					za.getLocation());
			...
			ZestExpressionStatusCode za = (ZestExpressionStatusCode) condition
					.getRootExpression();
