...
public class ZestAssertionsDialog extends StandardFieldsDialog {
	...
	private static final String FIELD_LOCATION = "zest.dialog.assert.label.location"; 
	...
	public void init (ScriptNode parent, ScriptNode child, ZestAssertion assertion, boolean add) {
		this.add = add;
		this.parent = parent;
		this.child = child;
		if (child != null) {
