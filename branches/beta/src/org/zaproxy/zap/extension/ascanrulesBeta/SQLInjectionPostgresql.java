 ...
 * 
 * Important Notes for the POSTGRES database (and useful in the code):
...
public class SQLInjectionPostgresql extends AbstractAppPlugin {
	...
	static {
		...
		//TODO: is this all?? we need more error messages for Postgresql for different languages. PHP, ASP, JSP(JDBC), etc 
	}
