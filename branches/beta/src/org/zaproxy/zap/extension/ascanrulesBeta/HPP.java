...
public class HPP extends AbstractAppPlugin {
	...
	public void generateReport( List<String> vulnLinks) {
		...
		try {
			bingo(Alert.RISK_MEDIUM, Alert.CONFIDENCE_MEDIUM, attack, getDescription(),getBaseMsg().getRequestHeader().getURI().getURI(), vulnParams, attack, getReference(), getSolution(), getBaseMsg());
