...
public class HttpFuzzResultsContentPanel extends JPanel implements FuzzResultsContentPanel<HttpMessage, HttpFuzzer> {
    ...
    public HttpFuzzResultsContentPanel() {
        ...
        showErrorsToggleButton.setToolTipText(Constant.messages.getString("fuzz.httpfuzzer.results.toolbar.button.showErrors.tooltip"));
        showErrorsToggleButton.setSelectedToolTipText(Constant.messages.getString("fuzz.httpfuzzer.results.toolbar.button.showErrors.tooltip.selected"));
        showErrorsToggleButton.setDisabledToolTipText(Constant.messages.getString("fuzz.httpfuzzer.results.toolbar.button.showErrors.tooltip.disabled"));
        showErrorsToggleButton.setIcon(new ImageIcon(HttpFuzzResultsContentPanel.class.getResource("/resource/icon/16/050.png")));
    ...
    private void hideErrorsTab() {
        ...
        showErrorsToggleButton.setText(Constant.messages.getString("fuzz.httpfuzzer.results.toolbar.button.showErrors.label"));
    ...
    private void showTabs() {
        ...
        tabbedPane.addTab(Constant.messages.getString("fuzz.httpfuzzer.results.tab.messages"), fuzzResultTableScrollPane);
        tabbedPane.addTab(Constant.messages.getString("fuzz.httpfuzzer.results.tab.errors"), errorsTableScrollPane);
        showErrorsToggleButton.setText(Constant.messages.getString("fuzz.httpfuzzer.results.toolbar.button.showErrors.label.selected"));
