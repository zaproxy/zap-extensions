    ...
    public Object getValueAt(int row, int col) {
        ...
        switch (col) {
        	...
        	case 1: 
		    		...
		    		case PASS:
		    			value = new ImageIcon(getClass().getResource("/resource/icon/16/072.png"));	// Green flag
		    			break;
		    		case HIGH:
		    			value = new ImageIcon(getClass().getResource("/resource/icon/16/074.png"));	// Yellow flag
		    			break;
		    		case MEDIUM:
		    			value = new ImageIcon(getClass().getResource("/resource/icon/16/076.png"));	// Orange flag
		    			break;
		    		case LOW:
		    			value = new ImageIcon(getClass().getResource("/resource/icon/16/075.png"));	// Pink flag
		    			break;
		    		case FAIL:
		    			value = new ImageIcon(getClass().getResource("/resource/icon/16/071.png"));	// Red flag
		    			break;
		    		}
        			break;
