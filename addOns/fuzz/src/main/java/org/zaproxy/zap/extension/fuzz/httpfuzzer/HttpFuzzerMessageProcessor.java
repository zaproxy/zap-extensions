...
public interface HttpFuzzerMessageProcessor extends FuzzerMessageProcessor<HttpMessage> {
     ...
     */
    HttpMessage processMessage(HttpFuzzerTaskProcessorUtils utils, HttpMessage message) throws ProcessingException;

    /**
     * Processes the result of fuzzing a message, after being sent to the server and before being displayed.
     *
     * @param utils utility class that contains methods that ease common tasks
     ...
     */
    boolean processResult(HttpFuzzerTaskProcessorUtils utils, HttpFuzzResult result) throws ProcessingException;
