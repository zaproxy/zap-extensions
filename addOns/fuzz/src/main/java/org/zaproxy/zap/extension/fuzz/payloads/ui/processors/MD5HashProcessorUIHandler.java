...
public class MD5HashProcessorUIHandler implements
    ...
    public static class MD5HashProcessorUI extends AbstractStringHashProcessorUI<MD5HashProcessor> {
        ...
        public String getDescription() {
            return Constant.messages.getString("fuzz.payload.processor.md5Hash.description", getCharset().name());
        }
    ...
    public static class MD5HashProcessorUIPanel extends
            AbstractStringHashProcessorUIPanel<MD5HashProcessor, MD5HashProcessorUI> {
        ...
        public MD5HashProcessorUI getPayloadProcessorUI() {
            return new MD5HashProcessorUI((Charset) getCharsetComboBox().getSelectedItem(), getUpperCaseCheckBox().isSelected());
        }
