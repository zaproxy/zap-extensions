...
public class ProcessorsPayloadDialog extends AbstractFormDialog {
    ...
    private static final String CONFIRM_BUTTON_LABEL = Constant.messages.getString("fuzz.fuzzer.dialog.payloads.dialog.processors.button.confirm");

    private static final String REMOVE_DIALOG_TITLE = Constant.messages.getString("fuzz.fuzzer.dialog.payloads.dialog.remove.processor.title");
    private static final String REMOVE_DIALOG_TEXT = Constant.messages.getString("fuzz.fuzzer.dialog.payloads.dialog.remove.processor.text");

    private static final String REMOVE_DIALOG_CONFIRM_BUTTON_LABEL = Constant.messages.getString("fuzz.fuzzer.dialog.payloads.dialog.remove.processor.button.confirm");
    private static final String REMOVE_DIALOG_CANCEL_BUTTON_LABEL = Constant.messages.getString("fuzz.fuzzer.dialog.payloads.dialog.remove.processor.button.cancel");

    private static final String REMOVE_DIALOG_CHECKBOX_LABEL = Constant.messages.getString("fuzz.fuzzer.dialog.payloads.dialog.remove.processor.checkbox.label");
    ...
    public ProcessorsPayloadDialog(Window parent, PayloadProcessorsContainer processorsUIHandlers) {
        super(parent, Constant.messages.getString("fuzz.fuzzer.dialog.payloads.dialog.processors.title"), false);
    ...
    protected JPanel getFieldsPanel() {
        ...
        JLabel processorsLabel = new JLabel(
                Constant.messages.getString("fuzz.fuzzer.dialog.payloads.dialog.processors.processors.label"));

        layout.setHorizontalGroup(layout.createParallelGroup().addComponent(processorsLabel).addComponent(processorsTablePanel));
        layout.setVerticalGroup(layout.createSequentialGroup().addComponent(processorsLabel).addComponent(processorsTablePanel));
