...
final class MultipleMessageLocationsReplacerTestUtils {

    private MultipleMessageLocationsReplacerTestUtils() {}

    @SafeVarargs
    static SortedSet<MessageLocationReplacementGenerator<?, ?>> generators(
    ...
    static final class RecordingReplacer implements MessageLocationReplacer<Message> {
    ...
    private static final class TestMessageLocation implements MessageLocation {
