...
/** Unit test for {@link MultipleMessageLocationsClusterBombReplacer}. */
class MultipleMessageLocationsClusterBombReplacerUnitTest {

    @Test
    void shouldIterateWithLastLocationChangingFastest()
    ...
    @Test
    void shouldReportCartesianProductSize() {
        // Given
        MultipleMessageLocationsReplacer<Message> multipleReplacer =
                new MultipleMessageLocationsClusterBombReplacer<>();
        SortedSet<MessageLocationReplacementGenerator<?, ?>> generators =
