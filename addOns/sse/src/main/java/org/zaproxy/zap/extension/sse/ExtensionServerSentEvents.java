...
/**
 * The Server-Sent Events (SSE) extension was written in December 2012. This
 * specification defines an API for opening an HTTP connection for receiving
 * push notifications from a server in the form of DOM events. See:
 * http://www.w3.org/TR/eventsource/.
 * 
 * @author Robert Koch
 */
public class ExtensionServerSentEvents extends ExtensionAdaptor implements PersistentConnectionListener, SessionChangedListener {
	 ...
	 */
	public void addEventStream(HttpMessage msg, final InputStream remoteReader, final OutputStream localWriter) {
