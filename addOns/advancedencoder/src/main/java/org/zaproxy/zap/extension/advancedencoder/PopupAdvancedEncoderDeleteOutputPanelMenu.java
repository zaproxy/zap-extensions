...
public class PopupAdvancedEncoderDeleteOutputPanelMenu extends ExtensionPopupMenuItem {

    private static final long serialVersionUID = 1L;
    private JTextComponent lastInvoker = null;

    /** This method initializes */
    public PopupAdvancedEncoderDeleteOutputPanelMenu() {
        super();
        initialize();
    }
    ...
    private boolean isInvokerFromEncodeDecode(Component invoker) {
        if (invoker.getName() == null) {
            ...
            return invoker.getName().equals(AdvancedEncodeDecodeDialog.ENCODE_DECODE_RESULTFIELD);
        }
    }
}
