...
class AddEncodeDecodeTabDialog extends AbstractFormDialog {
    ...
    private static final String DIALOG_TITLE =
            Constant.messages.getString("advancedencoder.dialog.addtab.title");
    private static final String NAME_FIELD_LABEL =
            Constant.messages.getString("advancedencoder.dialog.addtab.field.name.label");
    private static final String CONFIRM_BUTTON_LABEL =
            Constant.messages.getString("advancedencoder.dialog.addtab.button.confirm");
