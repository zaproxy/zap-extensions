...
import org.zaproxy.zap.extension.advancedencoder.processors.EncodeDecodeProcessorItem;
...
class AddEncodeDecodeOutputPanelDialog extends AbstractFormDialog {
    ...
    private static final String DIALOG_TITLE =
            Constant.messages.getString("advancedencoder.dialog.addoutputpanel.title");
    private static final String NAME_FIELD_LABEL =
            Constant.messages.getString("advancedencoder.dialog.addoutputpanel.field.name.label");
    private static final String SCRIPTS_FIELD_LABEL =
            Constant.messages.getString(
                    "advancedencoder.dialog.addoutputpanel.field.scripts.label");
    private static final String CONFIRM_BUTTON_LABEL =
            Constant.messages.getString("advancedencoder.dialog.addoutputpanel.button.confirm");
