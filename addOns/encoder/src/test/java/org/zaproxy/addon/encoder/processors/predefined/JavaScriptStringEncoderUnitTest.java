...
public class JavaScriptStringEncoderUnitTest extends ProcessorTests<JavaScriptStringEncoder> {

    @Override
    protected JavaScriptStringEncoder createProcessor() {
        return JavaScriptStringEncoder.getSingleton();
    }
