...
public class JavaScriptStringDecoderUnitTest extends ProcessorTests<JavaScriptStringDecoder> {

    @Override
    protected JavaScriptStringDecoder createProcessor() {
        return JavaScriptStringDecoder.getSingleton();
    }
