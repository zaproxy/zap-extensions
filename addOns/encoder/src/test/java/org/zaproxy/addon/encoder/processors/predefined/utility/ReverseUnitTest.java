...
class ReverseUnitTest extends ProcessorTests<Reverse> {

    @Override
    protected Reverse createProcessor() {
        return Reverse.getSingleton();
    }
    ...
    void shouldEncodeWithoutError() throws Exception {
        ...
        assertThat(result.getResult(), is(equalTo(">tpircs/<)'✅'(trela>tpircs<")));
    }
}
