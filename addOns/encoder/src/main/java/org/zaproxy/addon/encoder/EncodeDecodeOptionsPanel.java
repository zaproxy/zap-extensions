...
public class EncodeDecodeOptionsPanel extends AbstractParamPanel {
    ...
    private static final String NAME = Constant.messages.getString("encoder.optionspanel.name");
    private static final String NAME_BASE64 =
            Constant.messages.getString("encoder.optionspanel.base64");
    ...
    public void initParam(Object obj) {
        ...
        final EncodeDecodeOptions param = options.getParamSet(EncodeDecodeOptions.class);
