...
public class PlunginGuesser {
    ...
    public static void getJoomlaPluginDB() throws IOException {
        URL website =
                new URL(
                        "https://fuzzdb.googlecode.com/svn/trunk/Discovery/PredictableRes/CMS/joomla_plugins.fuzz.txt");
    ...
    public static void getWordpressPluginDB() throws IOException {
        URL website =
                new URL(
                        "https://fuzzdb.googlecode.com/svn/trunk/Discovery/PredictableRes/CMS/wp_plugins.fuzz.txt");
        ReadableByteChannel rbc = Channels.newChannel(website.openStream());
        @SuppressWarnings("resource")
    ...
    public static void getWordpressThemeDB() throws IOException {
        URL website =
                new URL(
                        "https://fuzzdb.googlecode.com/svn/trunk/Discovery/PredictableRes/CMS/wp_themes.fuzz.txt");
        ReadableByteChannel rbc = Channels.newChannel(website.openStream());
        @SuppressWarnings("resource")
    ...
    public static void getDrupalPluginDB() throws IOException {
        URL website =
                new URL(
                        "https://fuzzdb.googlecode.com/svn/trunk/Discovery/PredictableRes/CMS/drupal_plugins.fuzz.txt");
        ReadableByteChannel rbc = Channels.newChannel(website.openStream());
        @SuppressWarnings("resource")
    ...
    public static void getDrupalThemeDB() throws IOException {
        URL website =
                new URL(
                        "https://fuzzdb.googlecode.com/svn/trunk/Discovery/PredictableRes/CMS/drupal_themes.fuzz.txt");
        ReadableByteChannel rbc = Channels.newChannel(website.openStream());
        @SuppressWarnings("resource")
