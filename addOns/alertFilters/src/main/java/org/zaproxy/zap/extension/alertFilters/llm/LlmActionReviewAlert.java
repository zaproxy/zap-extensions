...
public class LlmActionReviewAlert {
    ...
    private static ExtensionAlert extAlert;
    ...
    public static void reviewAlert(Alert alert) {
                                ...
                                JsonSchema.builder()
                                        ...
                                        .rootElement(
                                                JsonObjectSchema.builder()
                                                        .addIntegerProperty("level")
                                                        .addStringProperty("explanation")
        ...
        try {
            ...
            AlertFeedback feedback =
                    new ObjectMapper().readValue(resp.aiMessage().text(), AlertFeedback.class);
            ...
            getExtAlert().updateAlertInTree(alert);
            ...
            if (View.isInitialised()) {
                View.getSingleton()
                        .showWarningDialog(
                                Constant.messages.getString("alertFilters.llm.reviewalert.error"));
            }
        }
    }
