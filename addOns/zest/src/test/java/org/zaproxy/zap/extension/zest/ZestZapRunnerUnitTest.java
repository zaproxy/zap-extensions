...
class ZestZapRunnerUnitTest extends TestUtils {
    ...
    @Test
    void shouldCaptureScreenshotBase64OnClientStatementFailureWhenWebDriverAvailable()
            throws Exception {
        ZestScriptWrapper wrapper = mock(ZestScriptWrapper.class);
        given(wrapper.getChainProvenance()).willReturn(Optional.empty());
        given(wrapper.getName()).willReturn("zest-script");
        ...
        ZestClientLaunch launch = new ZestClientLaunch("win1", "Firefox", "http://example.com");
        ZestClientFailException ex =
                new ZestClientFailException(launch, new IllegalStateException("fail"));

        invokeRecordStatementFailureContext(runnerWithWrapper, launch, ex);
    ...
    @Test
    void shouldCaptureScreenshotWhenWindowHandleBlankAndSingleWebDriverRegistered()
            throws Exception {
        ZestScriptWrapper wrapper = mock(ZestScriptWrapper.class);
        given(wrapper.getChainProvenance()).willReturn(Optional.empty());
        given(wrapper.getName()).willReturn("zest-script");
        ...
        ZestClientElementClick click = new ZestClientElementClick("", "xpath", "//a");
        ZestClientFailException ex =
