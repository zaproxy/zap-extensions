...
public class InsightsJob extends AutomationJob implements InsightListenner {
    ...
    public void runJob(AutomationEnvironment env, AutomationProgress progress) {
        this.getExtInsights().addInsightListenner(this);
    ...
    public void planFinished() {
        ...
        this.getExtInsights().removeInsightListenner(this);
    }
}
