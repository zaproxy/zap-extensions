...
public class ExtensionInsights extends ExtensionAdaptor {
    ...
    private List<InsightListenner> listenners = new ArrayList<>();
    ...
    public ExtensionInsights() {
        ...
        this.addInsightListenner(insights);
    ...
    public void hook(ExtensionHook extensionHook) {
        ...
        if (hasView()) {
            ...
            this.addInsightListenner(insightsPanel);
    ...
    public void addInsightListenner(InsightListenner listener) {
        this.listenners.add(listener);
    }

    public void removeInsightListenner(InsightListenner listener) {
