...
public class PopupMenuField extends PopupMenuItemHistoryReferenceContainer {
    ...
    private static final Logger LOGGER = LogManager.getLogger(PopupMenuField.class);

    private final ExtensionFieldEnumeration extension;

    public PopupMenuField(ExtensionFieldEnumeration extension) {
        super(Constant.messages.getString("fieldenumeration.field.popup"));
