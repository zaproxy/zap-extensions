...
public class EnumerationResult extends AbstractFrame {
    ...
    private static final Logger LOGGER = Logger.getLogger(EnumerationResult.class);
                        ...
                        chooser.setSelectedFile(
                                new File(
                                        Constant.messages.getString(
                                                "export.button.default.filename")));
    ...
    public void addFields(
        ...
        fieldSelected.setText(
                Constant.messages.getString("fieldenumeration.field.selected") + field.toString());
        fieldSelected.setFont(font);
        statusCode.setText(
                Constant.messages.getString("fieldenumeration.status.code") + regex.toString());
