 ...
 * following values:
 * <ul>
 * <li>{@link #ALLOWED} - the resource can be accessed by the User to which the rule refers</li>
 * <li>{@link #DENIED} - the resource should not be accessed by the User to which the rule refers</li>
 * <li>{@link #UNKNOWN} - there is no information regarding whether the resource should or shouldn't
 * be accessible to the User to which the rule refers</li>
 * </ul>
 * <p>
 * However, during the configuration of rules, the users can set the access rule to one of the
