...
public final class UriUtils {
	 ...
	 * Example outputs:
	 * <ul>
	 * <li><i>http://example.org</i></li>
	 * <li><i>http://example.org:8080</i></li>
	 * <li><i>https://example.org</i></li>
	 * </ul>
	 * 
	 * @throws URIException
	 */
	 ...
	 * <p/>
	 * If the parameter name is longer than 40 characters, it gets truncated.
	 * <p/>
	 * Example output: "<i>(param1,param2)</i>"
	 *
	 ...
	 * Example outputs:
	 * <ul>
	 * <li><i>example.jsp</i></li>
	 * <li><i>POST:login.php(pass,username)</i></li>
	 * <li><i>GET:index.html</i></li>
	 * <li><i>POST:upload.jsp(page)(filename)</i></li>
	 * <li><i>PUT:example.php(multipart/form-data)</i></li>
	 * </ul>
	 *
	 ...
	 *            otherwise
	 * @param formParameters the collection of parsed request body parameters, if any, or
	 *            {@code null} otherwise. Will be used only if the method is PUT or POST
	 ...
	 */
	public static String getLeafNodeRepresentation(String nodeName, String method,
