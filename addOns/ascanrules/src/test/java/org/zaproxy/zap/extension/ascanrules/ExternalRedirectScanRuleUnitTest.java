    ...
    class ExtractJsCommentsUnitTest {
        ...
        private static Stream<Arguments> commentProvider() {
            return Stream.of(
                    ...
                    Arguments.of("Block inside Single line", "// /* comment; */"),
                    Arguments.of(
                            "Single line inside Block comment", "/*  comment \n // example */"),
                    Arguments.of(
                            "Inline block",
                    ...
                    Arguments.of(
                            "Division before comment", "var x = 42 / 2; // division is not regex"),
                    Arguments.of(
                    ...
                    Arguments.of(
                            ...
                            "var re = /a\\/\\*b/; // trailing comment"),
                    Arguments.of("regex like in comment", "/* /http:\\/\\/evil.com/ */"));
        }

        @ParameterizedTest(name = "{0}")
        @MethodSource("commentProvider")
        void shouldFindAComment(String name, String content) {
            // Given / When
            Set<String> comments =
