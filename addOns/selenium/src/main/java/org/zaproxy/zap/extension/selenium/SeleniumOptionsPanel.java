    ...
    public void saveParam(Object obj) throws Exception {
        ...
        for (CustomBrowserImpl browser : allBrowsers) {
            if (browser.isBuiltIn()) {
                // Save built-in browsers
                if (Browser.CHROME.getId().equalsIgnoreCase(browser.getName())) {
                ...
                } else if (Browser.EDGE.getId().equalsIgnoreCase(browser.getName())) {
                ...
                } else if (Browser.FIREFOX.getId().equalsIgnoreCase(browser.getName())) {
