                ...
                if (matched) { // See if there's any version info.
                    ...
                    raiseAlert(
                            ...
                            Constant.messages.getString(
                                    "pscanalpha.serverheaderversioninfoleak.name"),
                            Constant.messages.getString(
                                    "pscanalpha.serverheaderversioninfoleak.desc"),
                            Constant.messages.getString(
                                    "pscanalpha.serverheaderinfoleak.general.soln"),
                            Constant.messages.getString(
                                    "pscanalpha.serverheaderinfoleak.general.refs"),
                            serverDirective,
                            msg,
                            id);
