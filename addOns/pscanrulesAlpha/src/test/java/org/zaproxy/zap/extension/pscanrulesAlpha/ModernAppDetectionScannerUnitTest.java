...
/**
 * Unit test for ModernAppDetectionScanner
 *
 * @see ModernAppDetectionScanner
 */
public class ModernAppDetectionScannerUnitTest
        extends PassiveScannerTest<ModernAppDetectionScanner> {

    @Override
    protected ModernAppDetectionScanner createScanner() {
        return new ModernAppDetectionScanner();
    }
