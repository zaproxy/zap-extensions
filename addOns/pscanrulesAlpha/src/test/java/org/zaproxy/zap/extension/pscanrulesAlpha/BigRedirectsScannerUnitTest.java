...
public class BigRedirectsScannerUnitTest extends PassiveScannerTest<BigRedirectsScanner> {
    ...
    @Override
    protected BigRedirectsScanner createScanner() {
        return new BigRedirectsScanner();
    }
    ...
    private static String getLocalisedString(String key, Object... params) {
        return Constant.messages.getString("pscanalpha.bigredirectsscanner." + key, params);
    }
}
