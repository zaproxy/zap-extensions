...
public class ParamsTableJdo implements DatabaseListener {

    private static PersistenceManagerFactory pmf;

    private final Database db;

    public ParamsTableJdo(Database db) throws DatabaseException {
        this.db = db;
    ...
    public void databaseOpen(DatabaseServer db) throws DatabaseException {
        ...
        Flyway.configure(classLoader)
                .table("PARAMS_FLYWAY_SCHEMA_HISTORY")
        ...
        pmf = JDOHelper.getPersistenceManagerFactory(jdoProperties, "params", classLoader);
    }
