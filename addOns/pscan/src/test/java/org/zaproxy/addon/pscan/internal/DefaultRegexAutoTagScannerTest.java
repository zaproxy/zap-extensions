...
class DefaultRegexAutoTagScannerTest {
    ...
    private static PassiveScannerOptions options;
    ...
    static void beforeAll() throws Exception {
        ...
        try (InputStream is =
            ...
            options.load(new ZapXmlConfiguration(is));
        }
    ...
    static Stream<Arguments> defaultRegexes() {
        return options.getAutoTagScanners().stream().map(e -> Arguments.of(e.getName(), e));
    }
    ...
    private RegexAutoTagScanner getRegexRuleByName(String taggerName) {
        for (RegexAutoTagScanner tagRule : options.getAutoTagScanners()) {
