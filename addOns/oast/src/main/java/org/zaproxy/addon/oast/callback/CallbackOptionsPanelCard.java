...
public class CallbackOptionsPanelCard extends OastOptionsPanelCard {
    ...
    public CallbackOptionsPanelCard(CallbackServer callbackServer) {
    ...
    public void initParam(Object obj) {
        ...
        if (proxyParam.getPort() == 0) {
            ...
            getSpinnerPort().setValue(callbackServer.getPort()); // As 0 isn't a valid port
        } else {
            getSpinnerPort().setEnabled(true);
            getSpinnerPort().setValue(proxyParam.getPort());
        }
        getTestURL().setText(callbackServer.getTestUrl());
    }
