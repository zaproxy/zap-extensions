...
/** Unit test for {@link ExtensionSequenceAutomation}. */
class ExtensionSequenceAutomationUnitTest extends TestUtils {

    private ExtensionSequenceAutomation extension;

    @BeforeEach
    void setUp() {
        extension = new ExtensionSequenceAutomation();
    ...
    @Test
    void shouldHaveName() {
        assertThat(extension.getName(), is(equalTo("ExtensionSequenceAutomation")));
    }
