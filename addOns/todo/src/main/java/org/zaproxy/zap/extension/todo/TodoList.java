...
public class TodoList extends AbstractPanel implements Tab {
	...
	public TodoList(){
		this.setIcon(new ImageIcon(TodoList.class.getResource("/org/zaproxy/zap/extension/todo/resources/ui-check-boxes.png")));
	...
	public NodeList parseXml() throws Exception{
		...
		InputStream xmlCheatSheet = TodoList.class.getResourceAsStream("/org/zaproxy/zap/extension/todo/resources/OWASP_Web_Application_Testing_Cheat_Sheet.xml");
