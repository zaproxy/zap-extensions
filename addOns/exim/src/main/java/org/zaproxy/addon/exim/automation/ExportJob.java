...
public class ExportJob extends AutomationJob {
    ...
    public void runJob(AutomationEnvironment env, AutomationProgress progress) {
        ...
        ExporterOptions options =
                ExporterOptions.builder()
                        ...
                        .setFormat(getParameters().getFormat())
                        .build();
    ...
    public static class Parameters extends AutomationData {
        ...
        private ExporterOptions.Type type = Type.HAR;
        private ExporterOptions.Format format = Format.HISTORY;
        ...
        public ExporterOptions.Type getType() {
            return type;
        }

        public void setType(ExporterOptions.Type type) {
            this.type = type;
        }

        public ExporterOptions.Format getFormat() {
            return format;
        }

        public void setFormat(ExporterOptions.Format format) {
            this.format = format;
        }
