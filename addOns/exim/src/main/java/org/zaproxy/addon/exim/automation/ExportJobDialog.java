...
public class ExportJobDialog extends StandardFieldsDialog {
    ...
    private static final String FORMAT_PARAM = "exim.automation.export.dialog.format";
    ...
    private DefaultComboBoxModel<ExporterOptions.Format> formatOptionModel;
    ...
    public ExportJobDialog(ExportJob job) {
        ...
        formatOptionModel = new DefaultComboBoxModel<>();
        Stream.of(ExporterOptions.Format.values()).forEach(formatOptionModel::addElement);
        formatOptionModel.setSelectedItem(job.getParameters().getFormat());
        this.addComboField(FORMAT_PARAM, formatOptionModel);
    ...
    public void save() {
        ...
        this.job
                .getParameters()
                .setFormat((ExporterOptions.Format) formatOptionModel.getSelectedItem());
