    ...
    protected void parse() {
        ...
        titleReport =
                getConfig()
                        .getString(
                                TITLE_REPORT,
                                messages.getString("alertreport.export.report.title.default"));
        ...
        customerName =
                getConfig()
                        .getString(
                                CUSTOMER_NAME,
                                messages.getString(
                                        "alertreport.export.report.title.customername.default"));
        confidentialText =
                getConfig()
                        .getString(
                                CONFIDENTIAL_TEXT,
                                messages.getString(
                                        "alertreport.export.report.confidentialtext.default"));
        pdfKeywords =
                getConfig()
                        .getString(
                                PDF_KEYWORDS,
                                messages.getString("alertreport.export.report.keywords.default"));
        authorName =
                getConfig()
                        .getString(
                                AUTHOR_NAME,
                                messages.getString("alertreport.export.report.authorname.default"));
        companyName =
                getConfig()
                        .getString(
                                COMPANY_NAME,
                                messages.getString(
                                        "alertreport.export.report.companyname.default"));
        formatReport =
                getConfig()
                        .getString(
                                FORMAT_REPORT,
                                messages.getString(
                                        "alertreport.export.report.formatreport.default"));
        documentAttach =
                getConfig().getString(DOCUMENT_ATTACH_FILE_NAME, DEFAULT_DOCUMENT_ATTACH_FILE_NAME);
    }
