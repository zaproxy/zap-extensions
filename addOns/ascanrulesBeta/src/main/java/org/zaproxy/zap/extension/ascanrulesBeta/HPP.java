...
/**
 * HPP is an effort to improve the anti-CSRF token detection of ZAP It is based on previous plugins
 * such as csrfcountermeasuresscan and sessionfixation
 *
 * <p>TODO note that this should extend AbstractAppParamPlugin rather than find parameters
 * internally
 */
