...
/**
 * The UsernameEnumeration plugin identifies vulnerabilities with the login page or "forgot
...
public class UsernameEnumeration extends AbstractAppPlugin {
    ...
    public void init() {
        ...
        if (!shouldContinue(extAuth.getModel().getSession().getContexts())) {
            ...
            this.getParent()
                    .pluginSkipped(this); // If there's no context we should just skip this plugin
