...
/**
 * The SessionFixation plugin identifies Session Fixation vulnerabilities with - cookie fields (a
...
public class SessionFixation extends AbstractAppPlugin {
    ...
    public void scan() {
        ...
        try {
            ...
            if (loginUrl == false) {
                log.debug(
                        "For the Session Fixation scanner to actually do anything, a Login Page *must* be set!");
                return;
            }
