 ...
 *
 * <p>The SQLInjectionHypersonic plugin identifies Hypersonic specific SQL Injection vulnerabilities
 * using Hypersonic specific syntax. If it doesn't use Hypersonic specific syntax, it belongs in the
 * generic SQLInjection class! Note the ordering of checks, for efficiency is : 1) Error based (N/A)
 * 2) Boolean Based (N/A - uses standard syntax) 3) UNION based (TODO) 4) Stacked (N/A - uses
 * standard syntax) 5) Blind/Time Based (Yes)
 *
 ...
 * @author 70pointer
 */
public class SQLInjectionHypersonic extends AbstractAppParamPlugin {
