...
/** Unit test for {@link SQLInjectionOracle}. */
public class SQLInjectionOracleUnitTest extends ActiveScannerTest<SQLInjectionOracle> {

    @Override
    protected SQLInjectionOracle createScanner() {
        return new SQLInjectionOracle();
    }
