...
/** Unit test for {@link SQLInjectionHypersonic}. */
public class SQLInjectionHypersonicUnitTest extends ActiveScannerTest<SQLInjectionHypersonic> {

    @Override
    protected SQLInjectionHypersonic createScanner() {
        return new SQLInjectionHypersonic();
    }
