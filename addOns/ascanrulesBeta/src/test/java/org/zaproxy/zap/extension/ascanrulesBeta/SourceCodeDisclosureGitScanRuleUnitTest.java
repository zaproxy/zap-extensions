...
class SourceCodeDisclosureGitScanRuleUnitTest
    ...
    void shouldFindGitRepoExposed() throws Exception {
        ...
        java.util.concurrent.atomic.AtomicBoolean indexRequested =
                new java.util.concurrent.atomic.AtomicBoolean(false);
        java.util.concurrent.atomic.AtomicBoolean objectRequested =
                new java.util.concurrent.atomic.AtomicBoolean(false);
        ...
        // If this valid binary is not served, the scanner will fail to inflate the file.
        // Generated using: hexdump -v -e '1/1 "(byte)0x%02X, "' .git/objects/$FOLDER/$FILE
        byte[] GIT_OBJECT_BYTES =
                new byte[] {
                    (byte) 0x78,
                    (byte) 0x01,
                    (byte) 0x4B,
        ...
        doAnswer(
                ...
                .when(testSender)
                .sendAndReceive(any(HttpMessage.class), anyBoolean());
        ...
        when(parent.getHttpSender()).thenReturn(testSender);
