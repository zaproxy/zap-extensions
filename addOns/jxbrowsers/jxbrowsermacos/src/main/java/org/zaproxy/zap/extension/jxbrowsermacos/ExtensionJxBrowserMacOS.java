 ...
 */
package org.zaproxy.zap.extension.jxbrowsermacos;
...
public class ExtensionJxBrowserMacOS extends ExtensionAdaptor {

    public static final String NAME = "ExtensionJxBrowserMaxOS";

    private static final Logger LOGGER = Logger.getLogger(ExtensionJxBrowserMacOS.class);
    ...
    public ExtensionJxBrowserMacOS() {
        super(NAME);
    }
