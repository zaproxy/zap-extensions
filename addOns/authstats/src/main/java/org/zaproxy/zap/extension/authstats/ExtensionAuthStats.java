...
public class ExtensionAuthStats extends ExtensionAdaptor implements HttpSenderListener {
    ...
    private static void updateAuthIndicatorStats(
            HttpMessage msg, String site, String prefix, Context context) {
        ...
        boolean loggedOut =
                loggedOutPattern != null && loggedOutPattern.matcher(fullResponse).find();
