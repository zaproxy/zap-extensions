...
public class TableJdo implements DatabaseListener {
    ...
    private static final String JDO_PMF_NAME = "scripts-db";
    ...
    public void databaseOpen(DatabaseServer db) throws DatabaseException {
        ...
        Flyway.configure(classLoader)
                .table("SCRIPTS_FLYWAY_SCHEMA_HISTORY")
        ...
        pmf = JDOHelper.getPersistenceManagerFactory(jdoProperties, JDO_PMF_NAME, classLoader);
    }
