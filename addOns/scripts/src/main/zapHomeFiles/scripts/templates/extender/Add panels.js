...
function install(helper) {
  if (helper.getView()) {
    ...
    helper
      ...
      .getMainFrame()
      .getWorkbench()
      .addPanel(selectpanel, paneltype.SELECT);
    ...
    helper
      ...
      .getMainFrame()
      .getWorkbench()
      .addPanel(statuspanel, paneltype.STATUS);
    // Set the focus just so that it appears - otherwise people might think it hasnt worked ;)
    ...
    helper
      ...
      .getMainFrame()
      .getWorkbench()
      .addPanel(workpanel, paneltype.WORK);
    // Set the focus just so that it appears - otherwise people might think it hasnt worked ;)
...
function uninstall(helper) {
  if (helper.getView()) {
    helper
      ...
      .getMainFrame()
      .getWorkbench()
      .removePanel(selectpanel, paneltype.SELECT);
    helper
      .getView()
      .getMainFrame()
      .getWorkbench()
      .removePanel(statuspanel, paneltype.STATUS);
    helper
      .getView()
      .getMainFrame()
      .getWorkbench()
      .removePanel(workpanel, paneltype.WORK);
  }
}
