...
- The CSP scan rule now alerts when the Content-Security-Policy header is missing, and (at low threshhold) when the obsolete X-Content-Security-Policy or X-WebKit-CSP are found (Issue 7653).
