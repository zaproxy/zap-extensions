...
## Unreleased
### Changed
- The PII Disclosure scan rule now only evaluates visible text at Medium or High alert threshold, while the entire response body is considered at Low alert threshold.
