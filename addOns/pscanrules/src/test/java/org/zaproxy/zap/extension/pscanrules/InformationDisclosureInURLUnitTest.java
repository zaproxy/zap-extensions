...
public class InformationDisclosureInURLUnitTest
        extends PassiveScannerTest<InformationDisclosureInURL> {
    ...
    protected InformationDisclosureInURL createScanner() {
        return new InformationDisclosureInURL();
    }
    ...
    public void setUpZap() throws Exception {
        ...
        Path xmlDir =
                Files.createDirectories(
                        Paths.get(
                                Constant.getZapHome(),
                                InformationDisclosureInURL.URL_SENSITIVE_INFORMATION_DIR));
        Path testFile = xmlDir.resolve(InformationDisclosureInURL.URL_SENSITIVE_INFORMATION_FILE);
