 ...
 * countermeasures in pages with forms. Based 95% on
 * org.zaproxy.zap.extension.pscan.scanner.CrossSiteRequestForgeryScanner but converted to an
 * extension, with clarified class name, and alert message and details to reflect the fact that the
 * class scans for a lack of CSRF countermeasures rather than for CSRF vulnerabilities. This class
 * is intended to deprecate org.zaproxy.zap.extension.pscan.scanner.CrossSiteRequestForgeryScanner
