...
public class ContentSecurityPolicyScanRule extends PluginPassiveScanner
    ...
    // used, if no base value then location.href
    // "plugin-types" is not included, the directive has been deprecated. "report-uri" is not
    // included as it has no literal impact.
    // "sandbox" does not fallback, but excluding it does not necessarily make anything 'more'
    // vulnerable, it's
    // use simply allows more detailed control of what embedded content can do.
