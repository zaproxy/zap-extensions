...
/**
 * a scanner to passively scan for the absence or insecure configuration of the X-XSS-Protection
...
public class HeaderXssProtectionScanner extends PluginPassiveScanner {
    ...
    private void raiseAlert(HttpMessage msg, int id, String xssHeaderProtection) {
        ...
        alert.setDetail(
                ...
                (xssHeaderProtection != null
                        ? HttpHeader.X_XSS_PROTECTION + ": " + xssHeaderProtection
                        : ""), // evidence, if any
