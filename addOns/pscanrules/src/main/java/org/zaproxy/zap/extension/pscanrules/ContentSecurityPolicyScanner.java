...
/**
 * Content Security Policy Header passive scan rule
 * https://github.com/zaproxy/zaproxy/issues/527
 * Meant to complement the CSP Header Missing passive scan rule
 * 
 * TODO: Add handling for multiple CSP headers 
 * TODO: Add handling for CSP via META tag 
 * See https://github.com/shapesecurity/salvation/issues/149
 * for info on combining CSP policies
 * 
...
public class ContentSecurityPolicyScanner extends PluginPassiveScanner {
	...
	public void scanHttpResponseReceive(HttpMessage msg, int id, Source source) {
		...
		if (LOGGER.isDebugEnabled()) {
			LOGGER.debug(
					"\tScan of record " + String.valueOf(id) + " took " + (System.currentTimeMillis() - start) + " ms");
		}
	}
	...
	/**
	 * Extracts a list of headers, and returns them without changing
	 * their cases.
