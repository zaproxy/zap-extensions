...
public class SpiderPanel extends ScanPanel2<SpiderScan, ScanController<SpiderScan>>
     ...
     */
    public SpiderPanel(ExtensionSpider2 extension, SpiderParam spiderScanParam) {
        super("spider", new ImageIcon(SpiderPanel.class.getResource("icon/spider.png")), extension);
        ...
        if (scanButton == null) {
            ...
            scanButton.setIcon(
                    DisplayUtils.getScaledIcon(
                            new ImageIcon(SpiderPanel.class.getResource("icon/spider.png"))));
    ...
    private static class ProcessedCellItemIconHighlighter
        ...
        private static final ImageIcon PROCESSED_ICON =
                new ImageIcon(SpiderPanelTableModel.class.getResource("icon/green_dot.png"));

        /** The icon that indicates the entry was not processed. */
        private static final ImageIcon NOT_PROCESSED_ICON =
                new ImageIcon(SpiderPanelTableModel.class.getResource("icon/red_dot.png"));
