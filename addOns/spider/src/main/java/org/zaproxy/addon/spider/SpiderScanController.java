...
import org.zaproxy.addon.spider.filters.MaxChildrenFetchFilter;
import org.zaproxy.addon.spider.filters.MaxChildrenParseFilter;
...
public class SpiderScanController implements ScanController<SpiderScan> {
    ...
    public SpiderScanController(ExtensionSpider2 extension) {
