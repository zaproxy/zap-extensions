...
public class ExtensionHttpsInfoAutomation extends ExtensionAdaptor {

    public static final String NAME = "ExtensionHttpsInfoAutomation";

    private HttpsInfoJob job;

    private static final List<Class<? extends Extension>> DEPENDENCIES;

    static {
        List<Class<? extends Extension>> dependencies = new ArrayList<>(2);
        dependencies.add(ExtensionHttpsInfo.class);
        dependencies.add(ExtensionAutomation.class);
        DEPENDENCIES = Collections.unmodifiableList(dependencies);
    }

    public ExtensionHttpsInfoAutomation() {
        super(NAME);
    }
    ...
    public String getDescription() {
        return Constant.messages.getString("httpsinfo.automation.desc");
    }

    @Override
    public String getUIName() {
        return Constant.messages.getString("httpsinfo.automation.name");
    }
}
