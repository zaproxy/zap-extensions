...
public class HttpsInfoJob extends AutomationJob {

    private static final String JOB_NAME = "httpsinfo";
    ...
    public List<JobResultData> getJobResultData() {
        return Collections.singletonList(new HttpsInfoJobResultData(this.getName()));
    }
