...
public class ExtensionHttpsInfo extends ExtensionAdaptor implements SessionChangedListener {
    ...
    static {
        ...
        dep.add(ExtensionNetwork.class);

        DEPENDENCIES = Collections.unmodifiableList(dep);
    }

    private HttpsConfigScanRule httpsConfigScanRule;
    ...
    public void init() {
        super.init();
        httpsConfigScanRule = new HttpsConfigScanRule();
        httpsConfigScanRule.setStatus(getAddOn().getStatus());
    }
    ...
    public void unload() {
        super.unload();
        if (httpsConfigScanRule != null) {
            PluginFactory.unloadedPlugin(httpsConfigScanRule);
        }
    }
    ...
    public void hook(ExtensionHook extensionHook) {
        ...
        PluginFactory.loadedPlugin(httpsConfigScanRule);
