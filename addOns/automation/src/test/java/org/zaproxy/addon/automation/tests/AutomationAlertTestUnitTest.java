...
class AutomationAlertTestUnitTest extends TestUtils {
    ...
    private Object setupAlert(Alert alert, String key, String value) {
        ...
        switch (key) {
            ...
            case AutomationAlertTest.PARAM_METHOD:
                ...
                msg.getRequestHeader().setMethod(value);
    ...
    @Test
    void shouldPassWithPassIfAbsentAndNoAlerts() {
        // Given
        String action = "passIfAbsent";
        AutomationProgress progress = new AutomationProgress();
        testData.put(AutomationAlertTest.PARAM_ACTION, action);
        ...
        AutomationAlertTest test = new AutomationAlertTest(testData, new ActiveScanJob(), progress);
        given(data.getAllAlertData()).willReturn(List.of());
        progress.addJobResultData(data);
    ...
    @Test
    void shouldFailWithPassIfPresentAndNoAlerts() {
        // Given
        String action = "passIfPresent";
        AutomationProgress progress = new AutomationProgress();
        testData.put(AutomationAlertTest.PARAM_ACTION, action);
    ...
    @Test
    void shouldFailOnAbsentJustMatchingId() {
        // Given
        String action = "passIfAbsent";
        testData.put(AutomationAlertTest.PARAM_ACTION, action);
        testData.put(AutomationAlertTest.PARAM_ON_FAIL, "error");
        ...
        alertList.add(alert);
        given(data.getAllAlertData()).willReturn(alertList);
        progress.addJobResultData(data);
        ...
        assertThat(progress.hasWarnings(), is(false));
        assertThat(progress.hasErrors(), is(true));
        assertThat(progress.getInfos().size(), is(4));
        assertThat(progress.getErrors().size(), is(1));
        assertThat(progress.getErrors().get(0), is("!automation.tests.fail!"));
        assertThat(test.runTest(progress), is(false));
    }
    ...
    @Test
    void shouldPassOnPresentSecondAlert() {
        // Given
        String action = "passIfPresent";
        testData.put(AutomationAlertTest.PARAM_ACTION, action);
        testData.put(AutomationAlertTest.PARAM_ON_FAIL, "error");
        ...
        // This won't match
        setupAlert(alert, AutomationAlertTest.PARAM_METHOD, "GET");

        // This will match
        Alert alert2 = new Alert(scanRuleId);
        alert2.setAlertId(1);
        setupAlert(alert2, AutomationAlertTest.PARAM_METHOD, "POST");

        testData.put(AutomationAlertTest.PARAM_METHOD, "POST");
    ...
    @Test
    void shouldPassOnAbsentWithNoJobData() {
        // Given
        String action = "passIfAbsent";
        testData.put(AutomationAlertTest.PARAM_ACTION, action);
        testData.put(AutomationAlertTest.PARAM_ON_FAIL, "error");
        ...
        assertThat(progress.hasWarnings(), is(false));
        assertThat(progress.hasErrors(), is(false));
        assertThat(progress.getInfos().size(), is(5));
        assertThat(test.runTest(progress), is(true));
    }
}
