...
public class MonitorTestDialog extends StandardFieldsDialog {

    private static final long serialVersionUID = 1L;

    private static final String TITLE = "automation.dialog.monitortest.title";
    private static final String NAME_PARAM = "automation.dialog.all.name";
    private static final String STATISTIC_PARAM = "automation.dialog.monitortest.statistic";
    private static final String SITE_PARAM = "automation.dialog.monitortest.site";
    private static final String THRESHOLD_PARAM = "automation.dialog.monitortest.threshold";
    private static final String ON_FAIL_PARAM = "automation.dialog.monitortest.onfail";

    private AutomationMonitorTest test;

    public MonitorTestDialog(AutomationMonitorTest test) {
        ...
        int i = 0;
        Long l = test.getData().getThreshold();
        if (l != null) {
            try {
                i = Math.toIntExact(test.getData().getThreshold());
            } catch (Exception e) {
                i = Integer.MAX_VALUE;
            }
        }
        ...
        this.addNumberField(THRESHOLD_PARAM, 0, Integer.MAX_VALUE, i);
        this.addPadding();
    }
    ...
    public void save() {
        ...
        this.test.getData().setThreshold(Long.valueOf(this.getIntValue(THRESHOLD_PARAM)));
