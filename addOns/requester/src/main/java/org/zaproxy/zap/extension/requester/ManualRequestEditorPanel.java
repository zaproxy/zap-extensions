 ...
 */
//Based on /zaproxy/src/org/parosproxy/paros/extension/manualrequest/ManualRequestEditorDialog.java
...
public abstract class ManualRequestEditorPanel extends JPanel implements Tab {
	 ...
	 */
	public ManualRequestEditorPanel(boolean isSendEnabled, String configurationKey) throws HeadlessException {
		super();
