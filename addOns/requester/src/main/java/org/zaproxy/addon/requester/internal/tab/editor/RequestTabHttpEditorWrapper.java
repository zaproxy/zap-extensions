...
/**
 * Wraps {@link ManualHttpRequestEditorPanel} in order to update tabStorage when appropriate methods
 * gets called.
 */
@Setter
...
public class RequestTabHttpEditorWrapper extends ManualHttpRequestEditorPanel {
     ...
     *
     * <p>(prevents updating messages during first load and unload)
     */
