...
public enum DBMSHelper {
    ...
    SQLITE(Tech.SQLite, new String[]{"sqlite", "sqlite3"}, 
            "||", 
    ...
    ACCESS(Tech.Access, new String[]{"msaccess", "access", "jet", "microsoft access"}, 
            "&", 
            "CVAR({0})", 
            "IIF(LEN({0})=0,''' ''',{0})", 
    ...
    FIREBIRD(Tech.Firebird, new String[]{"firebird", "mozilla firebird", "interbase", "ibase", "fb"}, 
            "", 
    ...
    MAXDB(Tech.MaxDB, new String[]{"maxdb", "sap maxdb", "sap db"}, 
            ",", 
            "REPLACE(CHR({0}),''' ''','''_''')", 
            "VALUE({0},''' ''')", 
            " FROM VERSIONS") {
    ...
    SYBASE(Tech.Sybase, new String[]{"sybase", "sybase sql server"}, 
            "+", 
    ...
    DB2(Tech.Db2, new String[]{"db2", "ibm db2", "ibmdb2"}, 
            "||", 
