...
public class ExtensionRetire extends ExtensionAdaptor implements ExampleAlertProvider {
    ...
    private Repo repo;
    private RetireScanRule passiveScanner;
    ...
    public void hook(ExtensionHook extensionHook) {
        ...
        passiveScanner = new RetireScanRule(repo);
