...
public class LlmLogResponseHandler implements ChatModelListener {
    ...
    private final String commsKey;

    public LlmLogResponseHandler(String commsKey) {
        this.commsKey = commsKey;
    }
    ...
    public void onResponse(ChatModelResponseContext responseContext) {
        LOGGER.info(
                "[{}] Token usage = {} ", commsKey, responseContext.chatResponse().tokenUsage());
        LOGGER.debug(
                "[{}] LLM Response = {} ",
                commsKey,
