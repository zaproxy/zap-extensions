...
public final class ZapProtocolExec implements ExecChainHandler {
    ...
    public ClassicHttpResponse execute(
        ...
        try {
            ...
            if (proxy != null && !route.isTunnelled()) {
                request = copy(userRequest, routeTarget);
            } else {
                request = userRequest;
            }
    ...
    private static ClassicHttpRequest copy(ClassicHttpRequest request, HttpHost routeTarget) {
        URIAuthority authority = request.getAuthority() == null ? new URIAuthority(routeTarget) : request.getAuthority();
        ...
        result.setAbsoluteRequestUri(true);
        return result;
    }
