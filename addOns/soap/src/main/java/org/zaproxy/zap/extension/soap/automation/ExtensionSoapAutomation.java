...
public class ExtensionSoapAutomation extends ExtensionAdaptor {
    ...
    public String getDescription() {
        return Constant.messages.getString("soap.automation.desc");
    }

    @Override
    public String getUIName() {
        return Constant.messages.getString("soap.automation.name");
    }
}
