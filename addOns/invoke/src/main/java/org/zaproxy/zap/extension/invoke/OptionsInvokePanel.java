...
public class OptionsInvokePanel extends AbstractParamPanel {
    ...
    private static class InvokableAppMultipleOptionsPanel
        ...
        private static final String REMOVE_DIALOG_TITLE =
                Constant.messages.getString("invoke.options.dialog.app.remove.title");
        private static final String REMOVE_DIALOG_TEXT =
                Constant.messages.getString("invoke.options.dialog.app.remove.text");

        private static final String REMOVE_DIALOG_CONFIRM_BUTTON_LABEL =
                Constant.messages.getString("invoke.options.dialog.app.remove.button.confirm");
        private static final String REMOVE_DIALOG_CANCEL_BUTTON_LABEL =
                Constant.messages.getString("invoke.options.dialog.app.remove.button.cancel");

        private static final String REMOVE_DIALOG_CHECKBOX_LABEL =
                Constant.messages.getString("invoke.options.dialog.app.remove.checkbox.label");
