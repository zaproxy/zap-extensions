...
public class MessageContentUnitTest extends WebSocketAddonTestUtils {
    ...
    public void shouldCloneBeTheSame() {
        ...
        // When
        MessageContent cloneContent = messageContent.clone();
    ...
    public void shouldGetHostNode()
        ...
        WebSocketProxy proxy =
                getMockWebSocketProxy(
                        getMockHistoryReference(hostUri1),
        ...
        // When
        List<TreeNode<WebSocketContent>> actualHostList =
                messageNode.getHostNodes(messageNode, new ArrayList<>());
    ...
    public void shouldGetMessagesPerHost()
        ...
        ArrayList<TreeNode<WebSocketContent>> messageFolder = new ArrayList<>();
        ArrayList<TreeNode<WebSocketContent>> messageNodes = new ArrayList<>();
        ...
        for (int i = 0; i < 5; i++) {
            ...
            if (i < 2) {
                ...
                messageFolder.add(
                        new WebSocketNode(
                                hostNodes.get(i),
                                new MessageFolderContent(namer, WebSocketMessage.OPCODE_TEXT)));
            }
            new WebSocketNode(
                    messageFolder.get(i % 2),
                    new MessageContent(
                            namer,
                            getWebSocketMessageDTO(
                                    getWebSocketChannelDTO(1, defaultHostName.toString()),
        ...
        List<WebSocketMessageDTO> messagesHost1 =
                root.getMessagesPerHost(root, new HashMap<>()).get(hostNodes.get(0));
        List<WebSocketMessageDTO> messagesHost2 =
                root.getMessagesPerHost(root, new HashMap<>()).get(hostNodes.get(1));
