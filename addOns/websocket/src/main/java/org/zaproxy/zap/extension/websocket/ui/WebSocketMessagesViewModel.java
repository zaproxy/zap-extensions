...
public class WebSocketMessagesViewModel extends PagingTableModel<WebSocketMessageDTO> {
    ...
    static {
        outgoingDirection =
                new ImageIcon(
                        WebSocketMessagesViewModel.class.getResource(
                                "/resource/icon/105_gray.png"));
        incomingDirection =
                new ImageIcon(
                        WebSocketMessagesViewModel.class.getResource(
                                "/resource/icon/106_gray.png"));
    }
     ...
     */
    public WebSocketMessagesViewModel(
            TableWebSocket webSocketTable, WebSocketMessagesViewFilter webSocketFilter) {
        this(webSocketTable);
     ...
     *
     * <p>Retrieves {@link WebSocketMessageDTO} from database with full payload.
     *
     * @param rowIndex
