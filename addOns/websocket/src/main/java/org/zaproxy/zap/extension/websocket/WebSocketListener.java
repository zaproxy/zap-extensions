 ...
 * blocking reads and passes read bytes to {@link WebSocketProxy} for processing. If you want to
 * listen (a.k.a. observe) for WebSocket messages, see the {@link WebSocketObserver} class.
 */
public class WebSocketListener implements Runnable {
    ...
    /**
     * Create listener, that calls the WebSocketsProxy instance to process read data. It contains
     * also the other end's writer to forward frames.
     *
    ...
    public WebSocketListener(
            WebSocketProxy wsProxy, InputStream in, OutputStream out, String name) {
