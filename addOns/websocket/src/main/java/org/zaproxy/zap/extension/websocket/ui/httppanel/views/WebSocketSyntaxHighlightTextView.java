...
public class WebSocketSyntaxHighlightTextView extends HttpPanelSyntaxHighlightTextView implements SelectableContentWebSocketMessageContainer {
	...
	public WebSocketSyntaxHighlightTextView(StringWebSocketPanelViewModel model) {
        ...
        getHttpPanelTextArea().setComponentPopupMenu(new CustomPopupMenu() {
            ...
            public void show(Component invoker, int x, int y) {
                ...
                View.getSingleton().getPopupMenu().show(WebSocketSyntaxHighlightTextView.this, x, y);
            };
        });
	}
	...
	protected static class WebSocketSyntaxHighlightTextArea extends HttpPanelSyntaxHighlightTextArea {
        ...
        private static final Logger LOGGER = Logger.getLogger(WebSocketSyntaxHighlightTextArea.class);
