...
public abstract class WebSocketBreakDialog extends AbstractDialog {
    ...
    protected WebSocketBreakpointMessage getWebSocketBreakpointMessage()
        ...
        WebSocketBreakpointMessage brkMsg =
                new WebSocketBreakpointMessage(opcode, channelId, payloadPattern, direction);
        return brkMsg;
    }
    ...
    protected void setDialogValues(
            String opcode, Integer channelId, String payloadPattern, Boolean isOutgoing) {
        if (opcode != null) {
