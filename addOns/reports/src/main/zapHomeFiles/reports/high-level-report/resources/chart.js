...
class Chart {
  ...
  getDatasetMeta(datasetIndex) {
    const me = this;
    const dataset = me._metasets[0].data[datasetIndex];
    const metasets = me._metasets;
    ...
    if (!meta) {
      meta = metasets[0][datasetIndex] = {
        type: me._metasets[0].type,
        data: dataset,
        dataset: null,
        controller: me._metasets[0].controller,
        hidden: null,
        xAxisID: null,
        yAxisID: null,
    ...
    console.log("in the getdatasetmeta function. var meta 2: "+meta)
    return meta;
  }
  getContext() {
  ...
  _updateDatasetVisibility(datasetIndex, visible) {
    ...
    console.log(meta)
    //const anims = me._resolveAnimations();
