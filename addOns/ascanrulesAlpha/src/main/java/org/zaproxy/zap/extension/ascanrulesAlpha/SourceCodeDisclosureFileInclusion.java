...
public class SourceCodeDisclosureFileInclusion extends AbstractAppParamPlugin {
    ...
    /** the logger object */
    private static Logger log = Logger.getLogger(SourceCodeDisclosureFileInclusion.class);
    ...
    public String getName() {
        return Constant.messages.getString("ascanalpha.sourcecodedisclosure.lfibased.name");
    }
                        ...
                        if (dataMatchesExtension(
                            ...
                            bingo(
                                    ...
                                    Constant.messages.getString(
                                            "ascanalpha.sourcecodedisclosure.lfibased.name"),
                                    Constant.messages.getString(
                                            "ascanalpha.sourcecodedisclosure.desc"),
                                    ...
                                    Constant.messages.getString(
                                            ...
                                            this.thresholdPercentage),
                                    Constant.messages.getString(
                                            "ascanalpha.sourcecodedisclosure.lfibased.soln"),
                                    Constant.messages.getString(
