...
public class SwaggerSecretDetectorScriptUnitTest extends GraalJsActiveScriptScanRuleTestUtils {
    ...
    void shouldReturnExpectedMappings() {
        assertThat(rule.getId(), is(equalTo(100043)));
        assertThat(rule.getName(), is(equalTo("Swagger Secret & Vulnerability Detector")));
        assertThat(rule.getCategory(), is(equalTo(Category.INFO_GATHER)));
        assertThat(rule.getRisk(), is(equalTo(Alert.RISK_HIGH)));
        assertThat(rule.getCweId(), is(equalTo(522)));
    ...
    void shouldCheckAllStaticPaths() throws Exception {
        ...
        // Then
        assertThat(alertsRaised, is(empty()));
        assertThat(nano.getRequestedUris(), hasSize(20));
        assertThat(
    ...
    void shouldRaiseAlertsForRegexPath(String path) throws Exception {
        ...
        assertThat(alertsRaised.get(0).getAlertRef(), is(equalTo("100043-1")));
        assertThat(alertsRaised.get(1).getAlertRef(), is(equalTo("100043-2")));
    }
