...
public class NonStdJsonBearerVerificationPage extends TestPage {

    private static final Logger LOGGER =
            LogManager.getLogger(NonStdJsonBearerVerificationPage.class);

    private static final String BEARER_PREFIX = "Bearer: ";

    public NonStdJsonBearerVerificationPage(TestProxyServer server) {
        super(server, "user");
    }
