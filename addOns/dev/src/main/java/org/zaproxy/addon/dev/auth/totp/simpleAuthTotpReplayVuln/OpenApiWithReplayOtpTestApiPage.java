...
public class OpenApiWithReplayOtpTestApiPage extends TestPage {

    private static final Logger LOGGER =
            LogManager.getLogger(OpenApiWithReplayOtpTestApiPage.class);

    public OpenApiWithReplayOtpTestApiPage(TestProxyServer server) {
