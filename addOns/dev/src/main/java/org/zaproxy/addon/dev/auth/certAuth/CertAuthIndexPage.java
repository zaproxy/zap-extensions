...
public class CertAuthIndexPage extends TestPage {

    private static final Logger LOGGER = LogManager.getLogger(CertAuthIndexPage.class);

    public CertAuthIndexPage(TestProxyServer server) {
