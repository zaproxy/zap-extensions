...
public class PasswordAddedNoSubmitLoginPage extends TestPage {

    private static final Logger LOGGER = LogManager.getLogger(PasswordAddedNoSubmitLoginPage.class);

    public PasswordAddedNoSubmitLoginPage(TestProxyServer server) {
        super(server, "login");
    }
    ...
    @Override
    public PasswordAddedNoSubmitDir getParent() {
        return (PasswordAddedNoSubmitDir) super.getParent();
    }
}
