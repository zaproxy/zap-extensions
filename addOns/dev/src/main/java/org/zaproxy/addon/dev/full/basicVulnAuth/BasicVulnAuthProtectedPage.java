...
public class BasicVulnAuthProtectedPage extends TestPage {

    private static final Logger LOGGER = LogManager.getLogger(BasicVulnAuthProtectedPage.class);

    public BasicVulnAuthProtectedPage(TestProxyServer server, String name) {
        super(server, name);
    }
    ...
    public void handleMessage(HttpMessageHandlerContext ctx, HttpMessage msg) {
        ...
        LOGGER.debug("Protected page {} accessed by user: {}", getName(), user);
    ...
    protected String getAuthenticatedUser(HttpMessage msg) {
