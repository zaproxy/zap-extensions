...
public class SimpleJsonVerificationPage extends TestPage {

    private static final Logger LOGGER = LogManager.getLogger(SimpleJsonVerificationPage.class);

    public SimpleJsonVerificationPage(TestProxyServer server) {
        super(server, "user");
    }
