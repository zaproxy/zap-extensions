...
public class OpenApiWithOtpTestApiPage extends TestPage {

    private static final Logger LOGGER = LogManager.getLogger(OpenApiWithOtpTestApiPage.class);

    public OpenApiWithOtpTestApiPage(TestProxyServer server) {
