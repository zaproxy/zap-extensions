...
public class SimpleJsonCookieDynamicPageVerificationPage extends TestPage {

    private static final Logger LOGGER =
            LogManager.getLogger(SimpleJsonCookieDynamicPageVerificationPage.class);

    public SimpleJsonCookieDynamicPageVerificationPage(TestProxyServer server) {
        super(server, "user");
    }
