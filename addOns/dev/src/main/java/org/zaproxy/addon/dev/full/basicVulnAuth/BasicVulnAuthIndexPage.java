...
public class BasicVulnAuthIndexPage extends TestPage {

    private static final Logger LOGGER = LogManager.getLogger(BasicVulnAuthIndexPage.class);

    public BasicVulnAuthIndexPage(TestProxyServer server) {
