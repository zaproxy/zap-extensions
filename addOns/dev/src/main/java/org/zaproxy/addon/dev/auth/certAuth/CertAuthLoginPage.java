...
public class CertAuthLoginPage extends TestPage {

    private static final Logger LOGGER = LogManager.getLogger(CertAuthLoginPage.class);

    public CertAuthLoginPage(TestProxyServer server) {
        super(server, "login");
    }
