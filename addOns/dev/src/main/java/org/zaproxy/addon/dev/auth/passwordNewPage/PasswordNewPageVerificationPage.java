...
public class PasswordNewPageVerificationPage extends TestPage {

    private static final Logger LOGGER =
            LogManager.getLogger(PasswordNewPageVerificationPage.class);

    public PasswordNewPageVerificationPage(TestProxyServer server) {
        super(server, "user");
    }
