 ...
 */
package org.zaproxy.addon.dev.auth.totp.simpleAuthTotpLockout;
...
public class OpenApiWithLockoutOtpLoginPage extends TestPage {

    private static final Logger LOGGER = LogManager.getLogger(OpenApiWithLockoutOtpLoginPage.class);

    public OpenApiWithLockoutOtpLoginPage(TestProxyServer server) {
        super(server, "login");
    }
    ...
    @Override
    public OpenApiWithLockoutOtpSimpleAuthDir getParent() {
        return (OpenApiWithLockoutOtpSimpleAuthDir) super.getParent();
    }
}
