...
public class SimpleJsonCookieDynamicPageLoginPage extends TestPage {

    private static final Logger LOGGER =
            LogManager.getLogger(SimpleJsonCookieDynamicPageLoginPage.class);

    public SimpleJsonCookieDynamicPageLoginPage(TestProxyServer server) {
        super(server, "login");
    }

    public SimpleJsonCookieDynamicPageLoginPage(TestProxyServer server, String path) {
        super(server, path);
    }
    ...
    public void handleMessage(HttpMessageHandlerContext ctx, HttpMessage msg) {
        ...
        if (msg.getRequestHeader().getURI().toString().endsWith("login")) {
            LOGGER.info("Login Form Action Handler");
            ...
            LOGGER.info("Login Form Display Handler");
            String body = this.getServer().getTextFile("login.html");
