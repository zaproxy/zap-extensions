...
public class PasswordHiddenJsonLoginPage extends TestPage {

    private static final Logger LOGGER = LogManager.getLogger(PasswordHiddenJsonLoginPage.class);

    public PasswordHiddenJsonLoginPage(TestProxyServer server) {
        super(server, "login");
    }
    ...
    @Override
    public PasswordHiddenJsonDir getParent() {
        return (PasswordHiddenJsonDir) super.getParent();
    }
}
