...
public class OpenApiWithReplayOtpLoginPage extends TestPage {

    private static final Logger LOGGER = LogManager.getLogger(OpenApiWithReplayOtpLoginPage.class);

    public OpenApiWithReplayOtpLoginPage(TestProxyServer server) {
        super(server, "login");
    }
