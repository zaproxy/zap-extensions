...
public class PasswordAddedJsonLoginPage extends TestPage {

    private static final Logger LOGGER = LogManager.getLogger(PasswordAddedJsonLoginPage.class);

    public PasswordAddedJsonLoginPage(TestProxyServer server) {
        super(server, "login");
    }
