...
public class OpenApiWithCaptchaOtpLoginPage extends TestPage {

    private static final Logger LOGGER = LogManager.getLogger(OpenApiWithCaptchaOtpLoginPage.class);

    public OpenApiWithCaptchaOtpLoginPage(TestProxyServer server) {
        super(server, "login");
    }
