...
public class OpenApiWithCommonOtpTestApiPage extends TestPage {

    private static final Logger LOGGER =
            LogManager.getLogger(OpenApiWithCommonOtpTestApiPage.class);

    public OpenApiWithCommonOtpTestApiPage(TestProxyServer server) {
