...
class McpResourceRegistryUnitTest {
    ...
    private static McpResource resourceWithUri(String uri) {
        ObjectNode listEntry = new ObjectMapper().createObjectNode();
        listEntry.put("uri", uri);
        listEntry.put("name", "test");
        listEntry.put("description", "Test resource");
        listEntry.put("mimeType", "application/json");
