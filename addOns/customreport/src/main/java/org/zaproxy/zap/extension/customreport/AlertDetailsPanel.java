...
public class AlertDetailsPanel extends JPanel{
	...
	private void initialize(){
	    ...
	    requestHeader.setText(Constant.messages.getString("customreport.alertdetails.requestheader"));
        gbc.gridx = 1;
     	gbc.gridy = 0;
	    ...
	    responseHeader.setText(Constant.messages.getString("customreport.alertdetails.responseheader"));
        gbc.gridy++;
		...
		this.add( new JLabel(Constant.messages.getString("customreport.alertdetails.label")), BorderLayout.NORTH );
