...
public class AllDiagnosticsPanel extends AbstractPanel {
    ...
    private final JButton importClipboardButton;
    ...
    public AllDiagnosticsPanel(TabbedPanel2 tabbedPane) {
        ...
        viewButton = new JButton(Constant.messages.getString("authhelper.authdiags.panel.view"));
        viewButton.setEnabled(false);
        viewButton.addActionListener(e -> showDiagnostic(getSelectedRow()));
        buttonsPanel.add(viewButton);

        removeButton =
                new JButton(Constant.messages.getString("authhelper.authdiags.panel.remove"));
        ...
        importButton =
                new JButton(Constant.messages.getString("authhelper.authdiags.panel.import.file"));
        ...
        importClipboardButton =
                new JButton(
                        Constant.messages.getString("authhelper.authdiags.panel.import.clipboard"));
        importClipboardButton.addActionListener(
                e ->
                        new Thread(
                                ...
                                .start());
        buttonsPanel.add(importClipboardButton);
        buttonsPanel.add(Box.createVerticalStrut(10));

        refreshButton =
                new JButton(Constant.messages.getString("authhelper.authdiags.panel.refresh"));
    ...
    private void importClipboardReport() {
        ...
        try {
            ...
            View.getSingleton()
                    .showWarningDialog(
                            Constant.messages.getString(
                                    "authhelper.authdiags.manager.import.error"));
            return;
        }
