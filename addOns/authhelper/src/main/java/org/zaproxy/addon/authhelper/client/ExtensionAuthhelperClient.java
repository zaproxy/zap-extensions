...
public class ExtensionAuthhelperClient extends ExtensionAdaptor {
    ...
    public void hook(ExtensionHook extensionHook) {
        ...
        extClient.addAuthenticationHandler(authHandler);
    }
    ...
    public void unload() {
        //        ExtensionClientIntegration extClient =
        //
        // Control.getSingleton().getExtensionLoader().getExtension(ExtensionClientIntegration.class);
        //        extClient.removeAuthenticationHandler(authHandler);
    }
