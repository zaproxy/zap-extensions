...
## Unreleased
### Added
- Allow users to limit the number of GraphQL messages to import (`maxMessages`) via the Automation Framework, Import dialogue, and API. Ex: If testing authentication, access, etc.
