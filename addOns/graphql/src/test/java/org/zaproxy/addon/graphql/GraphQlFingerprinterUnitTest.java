...
class GraphQlFingerprinterUnitTest extends TestUtils {
    ...
    private GraphQlFingerprinter buildFingerprinter(String endpointUrlStr) throws URIException {
        URI endpointUrl = UrlBuilder.build(endpointUrlStr);
        Requestor requestor =
                new Requestor(
                        new GraphQlQueryMessageBuilder(endpointUrl),
                        HttpSender.MANUAL_REQUEST_INITIATOR);
        return new GraphQlFingerprinter(endpointUrl, requestor);
    }
}
