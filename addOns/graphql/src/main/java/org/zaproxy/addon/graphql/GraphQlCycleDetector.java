...
public class GraphQlCycleDetector {
    ...
    private Map<GraphQLObjectType, Node> buildTypeGraph(GraphQLSchema schema) {
    ...
    private void strongConnect(Node node, Stack<Node> stack, AtomicInteger index, List<SCC> sccs) {
