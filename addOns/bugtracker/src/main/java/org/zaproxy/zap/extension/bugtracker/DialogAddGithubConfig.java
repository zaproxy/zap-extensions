...
class DialogAddGithubConfig extends AbstractFormDialog {
    ...
    private static final String DIALOG_TITLE =
            Constant.messages.getString("bugtracker.trackers.github.dialog.config.add.title");

    private static final String CONFIRM_BUTTON_LABEL =
            Constant.messages.getString(
                    "bugtracker.trackers.github.dialog.config.add.button.confirm");
    ...
    private static final String TITLE_NAME_REPEATED_DIALOG =
            Constant.messages.getString(
                    "bugtracker.trackers.github.dialog.config.warning.name.repeated.title");
            ...
            repoUrlTextField
                    ...
                    .addDocumentListener(
                            new DocumentListener() {
                                ...
                                private void checkAndEnableConfirmButton() {
                                    setConfirmButtonEnabled(
                                            getRepoUrlTextField().getDocument().getLength() > 0);
                                }
                            });
        }
