 ...
 * @see BrowserUI
 */
public class BrowsersComboBoxModel extends AbstractListModel<BrowserUI> implements ComboBoxModel<BrowserUI> {
     ...
     * 
     * @throws IllegalArgumentException if {@code item} is not a {@code BrowserUI} when non-{@code null}.
     */
    @Override
