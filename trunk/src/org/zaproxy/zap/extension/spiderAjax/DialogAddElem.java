...
class DialogAddElem extends AbstractFormDialog {
    ...
    private static final String DIALOG_TITLE = Constant.messages.getString("spiderajax.options.dialog.elem.add.title");
    
    private static final String CONFIRM_BUTTON_LABEL = Constant.messages.getString("spiderajax.options.dialog.elem.add.button.confirm");
    
    private static final String NAME_FIELD_LABEL = Constant.messages.getString("spiderajax.options.dialog.elem.field.label.name");
    private static final String ENABLED_FIELD_LABEL = Constant.messages.getString("spiderajax.options.dialog.elem.field.label.enabled");

    private static final String TITLE_NAME_REPEATED_DIALOG = Constant.messages.getString("spiderajax.options.dialog.elem.warning.name.repeated.title");
    private static final String TEXT_NAME_REPEATED_DIALOG = Constant.messages.getString("spiderajax.options.dialog.elem.warning.name.repeated.text");
    ...
    protected void performAction() {
        elem = new AjaxSpiderParamElem(getNameTextField().getText(), getEnabledCheckBox().isSelected());
    }
